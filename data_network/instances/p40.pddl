(define (problem p11-3-18-prob-11-3-18-ring-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           ...
           (SCRIPT-IO script2 data-0-6 data-0-11 data-1-8)
           (SCRIPT-IO script3 data-1-8 data-0-1 data-2-3)
           (SCRIPT-IO script4 data-1-2 data-1-8 data-2-5)
           (SCRIPT-IO script5 data-1-8 data-1-2 data-2-7)
           (SCRIPT-IO script6 data-1-8 data-1-2 data-2-9)
           (SCRIPT-IO script7 data-0-1 data-0-10 data-1-8)
           (SCRIPT-IO script8 data-1-8 data-0-10 data-2-7)
           (SCRIPT-IO script9 data-0-4 data-0-10 data-1-8)
           (SCRIPT-IO script10 data-0-4 data-0-10 data-1-2)
           (SCRIPT-IO script11 data-0-11 data-0-1 data-1-2)
           (SCRIPT-IO script12 data-1-8 data-0-1 data-2-9)
           (SCRIPT-IO script13 data-0-6 data-0-4 data-1-8)
           (SCRIPT-IO script14 data-0-4 data-0-10 data-1-2)
           (SCRIPT-IO script15 data-1-8 data-1-2 data-2-7)
           (SCRIPT-IO script16 data-1-8 data-1-2 data-2-5)
           (SCRIPT-IO script17 data-0-6 data-0-4 data-1-2)
           (SCRIPT-IO script18 data-1-2 data-0-1 data-2-9)
