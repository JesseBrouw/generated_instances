(define (problem p34-4-36-prob-34-4-36-ring-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (SCRIPT-IO script2 data-0-26 data-0-10 data-1-6)
           (SCRIPT-IO script3 data-0-8 data-0-22 data-1-7)
           (SCRIPT-IO script4 data-0-8 data-0-11 data-1-9)
           (SCRIPT-IO script5 data-0-5 data-0-26 data-1-14)
           (SCRIPT-IO script6 data-0-1 data-0-22 data-1-20)
           (SCRIPT-IO script7 data-0-1 data-0-8 data-1-27)
           (SCRIPT-IO script8 data-0-8 data-0-1 data-1-28)
           (SCRIPT-IO script9 data-0-5 data-0-8 data-1-29)
           (SCRIPT-IO script10 data-0-22 data-0-10 data-1-31)
           (SCRIPT-IO script11 data-0-1 data-0-11 data-1-33)
           (SCRIPT-IO script12 data-0-22 data-0-26 data-1-34)
           (SCRIPT-IO script13 data-1-14 data-1-2 data-2-3)
           (SCRIPT-IO script14 data-1-2 data-1-7 data-2-15)
           (SCRIPT-IO script15 data-1-14 data-0-1 data-2-16)
           (SCRIPT-IO script16 data-1-33 data-1-28 data-2-17)
           (SCRIPT-IO script17 data-1-28 data-1-29 data-2-23)
           (SCRIPT-IO script18 data-1-27 data-1-33 data-2-25)
           (SCRIPT-IO script19 data-1-31 data-1-2 data-2-30)
           (SCRIPT-IO script20 data-1-2 data-1-7 data-2-32)
           (SCRIPT-IO script21 data-2-3 data-2-16 data-3-4)
           (SCRIPT-IO script22 data-2-32 data-0-26 data-3-12)
           (SCRIPT-IO script23 data-2-3 data-0-26 data-3-13)
           (SCRIPT-IO script24 data-2-30 data-0-1 data-3-18)
           (SCRIPT-IO script25 data-2-32 data-0-1 data-3-19)
           (SCRIPT-IO script26 data-2-30 data-2-32 data-3-21)
           (SCRIPT-IO script27 data-2-25 data-0-11 data-3-24)
           (SCRIPT-IO script28 data-2-30 data-0-11 data-3-24)
           (SCRIPT-IO script29 data-2-16 data-0-5 data-3-4)
           (SCRIPT-IO script30 data-2-30 data-2-16 data-3-21)
           (SCRIPT-IO script31 data-0-1 data-0-11 data-1-27)
           (SCRIPT-IO script32 data-1-6 data-0-10 data-2-15)
           (SCRIPT-IO script33 data-0-26 data-0-22 data-1-34)
           (SCRIPT-IO script34 data-2-32 data-2-30 data-3-18)
           (SCRIPT-IO script35 data-0-8 data-0-1 data-1-28)
           (SCRIPT-IO script36 data-1-14 data-0-8 data-2-23)
           ...
           (= (process-cost script1 server6) 28)
           ...
           (= (process-cost script6 server5) 12)
           ...
           (= (process-cost script8 server7) 12)
           ...
           (= (process-cost script9 server5) 12)
           ...
           (= (process-cost script18 server5) 33)
