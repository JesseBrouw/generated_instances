(define (problem p5-3-9-prob-5-3-9-small-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           ...
           (SCRIPT-IO script4 data-1-2 data-0-4 data-2-5)
           ...
           (SCRIPT-IO script8 data-1-2 data-0-4 data-2-5)
           (SCRIPT-IO script9 data-0-1 data-0-4 data-1-2)
