(define (problem p34-4-36-prob-34-4-36-ring-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (= (process-cost script4 server5) 12)
           ...
           (= (process-cost script10 server6) 29)
           ...
           (= (process-cost script12 server2) 26)
           (= (process-cost script12 server3) 13)
           (= (process-cost script12 server4) 29)
           ...
           (= (process-cost script27 server7) 29)
           ...
           (= (process-cost script29 server4) 30)
    ...
    (:goal
           (and
                ...
                (saved data-3-10 server7)
                (saved data-3-16 server4)
                (saved data-3-20 server4)
                (saved data-3-33 server6)
           )
    )
