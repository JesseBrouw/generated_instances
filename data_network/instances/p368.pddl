(define (problem p30-4-47-prob-30-4-47-tiny-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           (SCRIPT-IO script1 data-0-8 data-0-30 data-1-2)
           (SCRIPT-IO script2 data-0-7 data-0-1 data-1-6)
           (SCRIPT-IO script3 data-0-14 data-0-30 data-1-9)
           (SCRIPT-IO script4 data-0-7 data-0-27 data-1-13)
           (SCRIPT-IO script5 data-0-27 data-0-30 data-1-19)
           (SCRIPT-IO script6 data-0-29 data-0-24 data-1-20)
           (SCRIPT-IO script7 data-0-30 data-0-8 data-1-21)
           (SCRIPT-IO script8 data-0-27 data-0-14 data-1-25)
           (SCRIPT-IO script9 data-1-13 data-1-6 data-2-3)
           (SCRIPT-IO script10 data-1-13 data-0-29 data-2-12)
           (SCRIPT-IO script11 data-1-2 data-0-27 data-2-15)
           (SCRIPT-IO script12 data-1-25 data-1-19 data-2-18)
           (SCRIPT-IO script13 data-1-9 data-0-1 data-2-28)
           (SCRIPT-IO script14 data-2-3 data-1-6 data-3-4)
           (SCRIPT-IO script15 data-2-18 data-0-29 data-3-10)
           (SCRIPT-IO script16 data-2-28 data-1-21 data-3-11)
           (SCRIPT-IO script17 data-2-15 data-0-23 data-3-16)
           (SCRIPT-IO script18 data-2-18 data-1-2 data-3-17)
           (SCRIPT-IO script19 data-2-18 data-0-14 data-3-22)
           (SCRIPT-IO script20 data-2-28 data-1-19 data-3-26)
           (SCRIPT-IO script21 data-1-19 data-0-1 data-2-3)
           (SCRIPT-IO script22 data-1-25 data-0-5 data-2-15)
           (SCRIPT-IO script23 data-1-9 data-0-14 data-2-3)
           (SCRIPT-IO script24 data-0-5 data-0-30 data-1-19)
           (SCRIPT-IO script25 data-0-8 data-0-5 data-1-9)
           (SCRIPT-IO script26 data-2-28 data-2-15 data-3-17)
           (SCRIPT-IO script27 data-2-12 data-2-15 data-3-4)
           (SCRIPT-IO script28 data-0-23 data-0-5 data-1-21)
           (SCRIPT-IO script29 data-2-3 data-2-12 data-3-17)
           (SCRIPT-IO script30 data-2-28 data-2-3 data-3-10)
           (SCRIPT-IO script31 data-1-6 data-1-25 data-2-3)
           (SCRIPT-IO script32 data-0-8 data-0-30 data-1-6)
           (SCRIPT-IO script33 data-1-19 data-1-21 data-2-28)
           (SCRIPT-IO script34 data-1-13 data-1-2 data-2-3)
           (SCRIPT-IO script35 data-1-25 data-1-20 data-2-15)
           (SCRIPT-IO script36 data-0-29 data-0-23 data-1-20)
           (SCRIPT-IO script37 data-0-5 data-0-29 data-1-20)
           (SCRIPT-IO script38 data-2-3 data-0-8 data-3-22)
           (SCRIPT-IO script39 data-0-1 data-0-8 data-1-9)
           (SCRIPT-IO script40 data-1-9 data-0-8 data-2-12)
           (SCRIPT-IO script41 data-0-1 data-0-27 data-1-21)
           (SCRIPT-IO script42 data-2-15 data-0-8 data-3-17)
           (SCRIPT-IO script43 data-0-14 data-0-7 data-1-2)
           (SCRIPT-IO script44 data-1-19 data-1-2 data-2-3)
           (SCRIPT-IO script45 data-1-19 data-0-8 data-2-15)
           (SCRIPT-IO script46 data-2-18 data-1-25 data-3-16)
           (SCRIPT-IO script47 data-2-18 data-2-28 data-3-17)
           ...
           (= (process-cost script27 server3) 6)
           ...
           (= (process-cost script41 server3) 4)
    ...
    (:goal
           (and
                ...
                (saved data-3-22 server3)
                (saved data-3-26 server3)
           )
    )
