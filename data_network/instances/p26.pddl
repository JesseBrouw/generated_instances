(define (problem p20-3-32-prob-20-3-32-ring-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           ...
           (SCRIPT-IO script3 data-0-15 data-0-11 data-1-9)
           (SCRIPT-IO script4 data-0-20 data-0-15 data-1-16)
           (SCRIPT-IO script5 data-0-15 data-0-11 data-1-17)
           (SCRIPT-IO script6 data-1-16 data-1-2 data-2-3)
           (SCRIPT-IO script7 data-1-2 data-0-20 data-2-7)
           (SCRIPT-IO script8 data-1-9 data-0-4 data-2-10)
           (SCRIPT-IO script9 data-1-16 data-1-17 data-2-12)
           (SCRIPT-IO script10 data-1-16 data-0-11 data-2-13)
           (SCRIPT-IO script11 data-1-17 data-0-11 data-2-14)
           (SCRIPT-IO script12 data-1-16 data-1-2 data-2-18)
           (SCRIPT-IO script13 data-1-16 data-0-20 data-2-19)
           (SCRIPT-IO script14 data-1-9 data-0-15 data-2-7)
           (SCRIPT-IO script15 data-0-15 data-0-11 data-1-16)
           (SCRIPT-IO script16 data-1-16 data-0-11 data-2-19)
           (SCRIPT-IO script17 data-1-2 data-0-11 data-2-19)
           (SCRIPT-IO script18 data-0-5 data-0-15 data-1-16)
           (SCRIPT-IO script19 data-0-15 data-0-1 data-1-17)
           (SCRIPT-IO script20 data-0-6 data-0-5 data-1-2)
           (SCRIPT-IO script21 data-0-4 data-0-6 data-1-8)
           (SCRIPT-IO script22 data-1-9 data-1-8 data-2-14)
           (SCRIPT-IO script23 data-0-1 data-0-6 data-1-17)
           (SCRIPT-IO script24 data-0-5 data-0-6 data-1-17)
           (SCRIPT-IO script25 data-0-6 data-0-20 data-1-17)
           (SCRIPT-IO script26 data-1-16 data-1-17 data-2-13)
           (SCRIPT-IO script27 data-1-16 data-0-5 data-2-19)
           (SCRIPT-IO script28 data-1-2 data-0-6 data-2-10)
           (SCRIPT-IO script29 data-0-11 data-0-20 data-1-9)
           (SCRIPT-IO script30 data-1-16 data-0-1 data-2-12)
           (SCRIPT-IO script31 data-0-1 data-0-4 data-1-17)
           (SCRIPT-IO script32 data-1-16 data-0-6 data-2-18)
           ...
           (= (process-cost script6 server5) 13)
           ...
           (= (process-cost script18 server6) 13)
           (= (process-cost script18 server7) 21)
           (= (process-cost script19 server1) 9)
           (= (process-cost script19 server2) 30)
