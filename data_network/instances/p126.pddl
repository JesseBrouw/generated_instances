(define (problem p22-5-24-prob-22-5-24-small-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (SCRIPT-IO script3 data-0-16 data-0-1 data-1-14)
           (SCRIPT-IO script4 data-0-1 data-0-6 data-1-15)
           (SCRIPT-IO script5 data-0-6 data-0-1 data-1-17)
           (SCRIPT-IO script6 data-0-1 data-0-16 data-1-18)
           (SCRIPT-IO script7 data-0-6 data-0-16 data-1-21)
           (SCRIPT-IO script8 data-1-14 data-1-18 data-2-3)
           (SCRIPT-IO script9 data-1-14 data-1-17 data-2-7)
           (SCRIPT-IO script10 data-1-18 data-1-14 data-2-10)
           (SCRIPT-IO script11 data-2-3 data-2-7 data-3-4)
           (SCRIPT-IO script12 data-2-3 data-2-10 data-3-12)
           (SCRIPT-IO script13 data-2-10 data-2-3 data-3-13)
           (SCRIPT-IO script14 data-3-12 data-2-7 data-4-5)
           (SCRIPT-IO script15 data-3-12 data-2-10 data-4-8)
           (SCRIPT-IO script16 data-3-12 data-1-15 data-4-9)
           (SCRIPT-IO script17 data-3-13 data-2-7 data-4-19)
           (SCRIPT-IO script18 data-3-12 data-1-11 data-4-20)
           (SCRIPT-IO script19 data-3-13 data-1-11 data-4-22)
           (SCRIPT-IO script20 data-3-12 data-2-10 data-4-5)
           (SCRIPT-IO script21 data-1-18 data-1-11 data-2-7)
           (SCRIPT-IO script22 data-0-1 data-0-6 data-1-18)
           (SCRIPT-IO script23 data-0-1 data-0-16 data-1-17)
           (SCRIPT-IO script24 data-0-6 data-0-16 data-1-18)
           ...
           (= (process-cost script7 server3) 3)
    ...
    (:goal
           (and
                ...
                (saved data-1-21 server2)
                (saved data-3-4 server3)
                (saved data-4-5 server4)
                (saved data-4-8 server1)
                (saved data-4-9 server2)
                (saved data-4-19 server4)
