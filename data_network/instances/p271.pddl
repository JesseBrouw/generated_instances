(define (problem p42-5-65-prob-42-5-65-small-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (= (process-cost script2 server4) 8)
           ...
           (= (process-cost script21 server4) 5)
           ...
           (= (process-cost script26 server4) 8)
           ...
           (= (process-cost script53 server4) 5)
           ...
           (= (process-cost script58 server4) 7)
           ...
           (= (process-cost script64 server4) 9)
    ...
    (:goal
           (and
                ...
                (saved data-4-30 server3)
                (saved data-4-36 server2)
                (saved data-4-39 server1)
           )
    )
