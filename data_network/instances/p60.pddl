(define (problem p26-3-41-prob-26-3-41-ring-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           ...
           (= (process-cost script8 server6) 32)
           ...
           (= (process-cost script20 server7) 8)
           ...
           (= (process-cost script29 server7) 28)
           (= (process-cost script30 server1) 8)
           (= (process-cost script30 server2) 30)
           ...
           (= (process-cost script31 server6) 12)
           ...
           (= (process-cost script32 server4) 28)
           (= (process-cost script32 server5) 23)
           (= (process-cost script32 server6) 9)
           ...
           (= (process-cost script33 server5) 16)
    ...
    (:goal
           (and
                (saved data-1-2 server6)
                (saved data-1-5 server7)
