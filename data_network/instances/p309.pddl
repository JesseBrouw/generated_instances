(define (problem p5-3-9-prob-5-3-9-tiny-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           (SCRIPT-IO script1 data-0-5 data-0-4 data-1-2)
           (SCRIPT-IO script2 data-1-2 data-0-1 data-2-3)
           (SCRIPT-IO script3 data-0-1 data-0-4 data-1-2)
           (SCRIPT-IO script4 data-1-2 data-0-1 data-2-3)
           (SCRIPT-IO script5 data-0-5 data-0-4 data-1-2)
           ...
           (= (process-cost script7 server1) 28)
