(define (problem p22-5-35-prob-22-5-35-tiny-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           (SCRIPT-IO script1 data-0-1 data-0-6 data-1-2)
           (SCRIPT-IO script2 data-0-6 data-0-1 data-1-10)
           (SCRIPT-IO script3 data-0-6 data-0-1 data-1-13)
           (SCRIPT-IO script4 data-0-6 data-0-1 data-1-15)
           (SCRIPT-IO script5 data-0-1 data-0-6 data-1-16)
           (SCRIPT-IO script6 data-1-16 data-1-15 data-2-3)
           (SCRIPT-IO script7 data-1-16 data-0-6 data-2-7)
           (SCRIPT-IO script8 data-1-2 data-0-1 data-2-9)
           (SCRIPT-IO script9 data-1-10 data-1-16 data-2-11)
           (SCRIPT-IO script10 data-1-16 data-0-1 data-2-12)
           (SCRIPT-IO script11 data-1-16 data-1-13 data-2-14)
           (SCRIPT-IO script12 data-1-13 data-1-16 data-2-18)
           (SCRIPT-IO script13 data-1-13 data-0-1 data-2-22)
           (SCRIPT-IO script14 data-2-3 data-1-13 data-3-4)
           (SCRIPT-IO script15 data-3-4 data-2-14 data-4-5)
           (SCRIPT-IO script16 data-3-4 data-1-13 data-4-8)
           (SCRIPT-IO script17 data-3-4 data-0-6 data-4-17)
           (SCRIPT-IO script18 data-3-4 data-0-1 data-4-19)
           (SCRIPT-IO script19 data-3-4 data-1-15 data-4-20)
           (SCRIPT-IO script20 data-3-4 data-1-16 data-4-21)
           (SCRIPT-IO script21 data-1-16 data-0-6 data-2-3)
           (SCRIPT-IO script22 data-2-14 data-2-22 data-3-4)
           (SCRIPT-IO script23 data-0-1 data-0-6 data-1-16)
           (SCRIPT-IO script24 data-1-10 data-0-1 data-2-18)
           (SCRIPT-IO script25 data-1-13 data-0-6 data-2-7)
           (SCRIPT-IO script26 data-2-7 data-2-3 data-3-4)
           (SCRIPT-IO script27 data-2-12 data-0-6 data-3-4)
           (SCRIPT-IO script28 data-1-16 data-1-13 data-2-22)
           (SCRIPT-IO script29 data-3-4 data-1-10 data-4-20)
           (SCRIPT-IO script30 data-2-7 data-1-10 data-3-4)
           (SCRIPT-IO script31 data-0-6 data-0-1 data-1-2)
           (SCRIPT-IO script32 data-1-16 data-0-6 data-2-11)
           (SCRIPT-IO script33 data-0-6 data-0-1 data-1-10)
           (SCRIPT-IO script34 data-1-15 data-1-16 data-2-12)
           (SCRIPT-IO script35 data-3-4 data-1-16 data-4-19)
    ...
    (:goal
           (and
                ...
                (saved data-4-8 server3)
                (saved data-4-17 server1)
                (saved data-4-19 server1)
