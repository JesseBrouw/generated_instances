(define (problem p6-4-11-prob-6-4-11-tiny-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (SCRIPT-IO script2 data-1-2 data-0-1 data-2-3)
           (SCRIPT-IO script3 data-2-3 data-0-1 data-3-4)
           (SCRIPT-IO script4 data-2-3 data-1-2 data-3-6)
           (SCRIPT-IO script5 data-2-3 data-1-2 data-3-4)
           (SCRIPT-IO script6 data-2-3 data-1-2 data-3-4)
           (SCRIPT-IO script7 data-0-1 data-0-5 data-1-2)
           (SCRIPT-IO script8 data-1-2 data-0-1 data-2-3)
           (SCRIPT-IO script9 data-0-1 data-0-5 data-1-2)
           (SCRIPT-IO script10 data-1-2 data-0-1 data-2-3)
           (SCRIPT-IO script11 data-2-3 data-1-2 data-3-6)
