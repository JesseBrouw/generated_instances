(define (problem p26-3-41-prob-26-3-41-tiny-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           (SCRIPT-IO script1 data-0-12 data-0-8 data-1-2)
           (SCRIPT-IO script2 data-0-1 data-0-7 data-1-5)
           (SCRIPT-IO script3 data-0-25 data-0-7 data-1-14)
           (SCRIPT-IO script4 data-0-16 data-0-12 data-1-18)
           (SCRIPT-IO script5 data-0-16 data-0-8 data-1-20)
           (SCRIPT-IO script6 data-0-25 data-0-7 data-1-21)
           (SCRIPT-IO script7 data-0-4 data-0-10 data-1-23)
           (SCRIPT-IO script8 data-1-2 data-1-21 data-2-3)
           (SCRIPT-IO script9 data-1-23 data-1-21 data-2-6)
           (SCRIPT-IO script10 data-1-21 data-1-14 data-2-9)
           (SCRIPT-IO script11 data-1-20 data-0-22 data-2-11)
           (SCRIPT-IO script12 data-1-23 data-1-20 data-2-13)
           (SCRIPT-IO script13 data-1-21 data-0-25 data-2-15)
           (SCRIPT-IO script14 data-1-14 data-1-18 data-2-17)
           (SCRIPT-IO script15 data-1-2 data-0-12 data-2-19)
           (SCRIPT-IO script16 data-1-18 data-1-2 data-2-24)
           (SCRIPT-IO script17 data-1-2 data-0-12 data-2-26)
           (SCRIPT-IO script18 data-1-23 data-1-14 data-2-6)
           (SCRIPT-IO script19 data-1-18 data-0-4 data-2-13)
           (SCRIPT-IO script20 data-0-1 data-0-25 data-1-14)
           (SCRIPT-IO script21 data-0-10 data-0-7 data-1-21)
           (SCRIPT-IO script22 data-1-5 data-1-14 data-2-19)
           (SCRIPT-IO script23 data-1-5 data-0-1 data-2-3)
           (SCRIPT-IO script24 data-1-21 data-1-14 data-2-3)
           (SCRIPT-IO script25 data-0-4 data-0-8 data-1-21)
           (SCRIPT-IO script26 data-1-5 data-0-16 data-2-11)
           (SCRIPT-IO script27 data-0-4 data-0-12 data-1-18)
           (SCRIPT-IO script28 data-1-2 data-1-20 data-2-19)
           (SCRIPT-IO script29 data-1-21 data-1-14 data-2-6)
           (SCRIPT-IO script30 data-0-1 data-0-10 data-1-14)
           (SCRIPT-IO script31 data-0-4 data-0-25 data-1-18)
           (SCRIPT-IO script32 data-1-21 data-0-7 data-2-26)
           (SCRIPT-IO script33 data-1-18 data-1-14 data-2-24)
           (SCRIPT-IO script34 data-0-16 data-0-8 data-1-2)
           (SCRIPT-IO script35 data-0-12 data-0-4 data-1-2)
           (SCRIPT-IO script36 data-1-18 data-1-14 data-2-11)
           (SCRIPT-IO script37 data-0-12 data-0-7 data-1-21)
           (SCRIPT-IO script38 data-1-5 data-0-12 data-2-17)
           (SCRIPT-IO script39 data-0-10 data-0-25 data-1-21)
           (SCRIPT-IO script40 data-0-8 data-0-22 data-1-14)
           (SCRIPT-IO script41 data-1-21 data-0-12 data-2-26)
           ...
           (= (process-cost script9 server1) 27)
