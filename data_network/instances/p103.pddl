(define (problem p6-4-11-prob-6-4-11-small-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (SCRIPT-IO script6 data-2-3 data-1-2 data-3-6)
           (SCRIPT-IO script7 data-1-2 data-0-5 data-2-3)
           ...
           (= (process-cost script1 server4) 5)
