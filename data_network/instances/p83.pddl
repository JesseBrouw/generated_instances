(define (problem p18-2-29-prob-18-2-29-small-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           (SCRIPT-IO script1 data-0-3 data-0-12 data-1-2)
           (SCRIPT-IO script2 data-0-4 data-0-3 data-1-5)
           (SCRIPT-IO script3 data-0-4 data-0-9 data-1-7)
           (SCRIPT-IO script4 data-0-10 data-0-1 data-1-8)
           (SCRIPT-IO script5 data-0-3 data-0-9 data-1-11)
           (SCRIPT-IO script6 data-0-4 data-0-9 data-1-13)
           (SCRIPT-IO script7 data-0-9 data-0-12 data-1-14)
           (SCRIPT-IO script8 data-0-1 data-0-10 data-1-15)
           (SCRIPT-IO script9 data-0-9 data-0-4 data-1-16)
           (SCRIPT-IO script10 data-0-10 data-0-3 data-1-18)
           (SCRIPT-IO script11 data-0-6 data-0-3 data-1-15)
           (SCRIPT-IO script12 data-0-1 data-0-12 data-1-16)
           (SCRIPT-IO script13 data-0-3 data-0-10 data-1-13)
           (SCRIPT-IO script14 data-0-1 data-0-4 data-1-14)
           (SCRIPT-IO script15 data-0-1 data-0-10 data-1-14)
           (SCRIPT-IO script16 data-0-17 data-0-6 data-1-11)
           (SCRIPT-IO script17 data-0-6 data-0-3 data-1-5)
           (SCRIPT-IO script18 data-0-1 data-0-6 data-1-8)
           (SCRIPT-IO script19 data-0-17 data-0-10 data-1-8)
           (SCRIPT-IO script20 data-0-1 data-0-12 data-1-11)
           (SCRIPT-IO script21 data-0-10 data-0-3 data-1-14)
           (SCRIPT-IO script22 data-0-17 data-0-9 data-1-14)
           (SCRIPT-IO script23 data-0-6 data-0-3 data-1-11)
           (SCRIPT-IO script24 data-0-3 data-0-4 data-1-7)
           (SCRIPT-IO script25 data-0-10 data-0-9 data-1-5)
           (SCRIPT-IO script26 data-0-1 data-0-12 data-1-2)
           (SCRIPT-IO script27 data-0-4 data-0-10 data-1-8)
           (SCRIPT-IO script28 data-0-1 data-0-3 data-1-5)
           (SCRIPT-IO script29 data-0-10 data-0-12 data-1-5)
    ...
    (:goal
           (and
                ...
                (saved data-1-16 server3)
                (saved data-1-18 server3)
           )
    )
