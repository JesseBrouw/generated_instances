(define (problem p22-4-35-prob-22-4-35-tiny-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           (SCRIPT-IO script1 data-0-18 data-0-9 data-1-2)
           (SCRIPT-IO script2 data-0-5 data-0-21 data-1-8)
           (SCRIPT-IO script3 data-0-1 data-0-9 data-1-15)
           (SCRIPT-IO script4 data-1-8 data-0-5 data-2-3)
           (SCRIPT-IO script5 data-1-8 data-0-5 data-2-11)
           (SCRIPT-IO script6 data-1-15 data-0-9 data-2-12)
           (SCRIPT-IO script7 data-1-8 data-1-15 data-2-17)
           (SCRIPT-IO script8 data-1-2 data-0-21 data-2-20)
           (SCRIPT-IO script9 data-1-2 data-0-9 data-2-22)
           (SCRIPT-IO script10 data-2-3 data-0-21 data-3-4)
           (SCRIPT-IO script11 data-2-12 data-0-9 data-3-6)
           (SCRIPT-IO script12 data-2-20 data-1-15 data-3-7)
           (SCRIPT-IO script13 data-2-22 data-2-17 data-3-13)
           (SCRIPT-IO script14 data-2-3 data-2-11 data-3-14)
           (SCRIPT-IO script15 data-2-20 data-0-5 data-3-16)
           (SCRIPT-IO script16 data-1-8 data-0-18 data-2-11)
           (SCRIPT-IO script17 data-2-20 data-1-15 data-3-13)
           (SCRIPT-IO script18 data-0-10 data-0-1 data-1-15)
           (SCRIPT-IO script19 data-0-10 data-0-19 data-1-8)
           (SCRIPT-IO script20 data-1-2 data-0-9 data-2-3)
           (SCRIPT-IO script21 data-1-8 data-1-15 data-2-17)
           (SCRIPT-IO script22 data-1-2 data-1-15 data-2-12)
           (SCRIPT-IO script23 data-1-15 data-1-2 data-2-20)
           (SCRIPT-IO script24 data-2-12 data-1-2 data-3-4)
           (SCRIPT-IO script25 data-0-9 data-0-5 data-1-15)
           (SCRIPT-IO script26 data-1-15 data-0-5 data-2-11)
           (SCRIPT-IO script27 data-0-21 data-0-10 data-1-2)
           (SCRIPT-IO script28 data-1-15 data-0-21 data-2-17)
           (SCRIPT-IO script29 data-0-19 data-0-10 data-1-2)
           (SCRIPT-IO script30 data-2-22 data-2-11 data-3-7)
           (SCRIPT-IO script31 data-1-8 data-0-10 data-2-20)
           (SCRIPT-IO script32 data-2-17 data-1-8 data-3-4)
           (SCRIPT-IO script33 data-0-18 data-0-9 data-1-8)
           (SCRIPT-IO script34 data-1-8 data-1-15 data-2-22)
           (SCRIPT-IO script35 data-0-1 data-0-18 data-1-15)
           ...
           (= (process-cost script3 server1) 31)
           ...
           (= (process-cost script7 server2) 4)
           ...
           (= (process-cost script29 server1) 26)
           ...
           (= (process-cost script33 server1) 27)
