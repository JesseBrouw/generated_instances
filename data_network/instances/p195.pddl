(define (problem p22-5-24-prob-22-5-24-tiny-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           (SCRIPT-IO script1 data-0-13 data-0-19 data-1-2)
           (SCRIPT-IO script2 data-0-21 data-0-6 data-1-15)
           (SCRIPT-IO script3 data-1-15 data-0-13 data-2-3)
           (SCRIPT-IO script4 data-1-2 data-0-6 data-2-7)
           (SCRIPT-IO script5 data-1-15 data-1-2 data-2-16)
           (SCRIPT-IO script6 data-1-15 data-0-19 data-2-20)
           (SCRIPT-IO script7 data-2-7 data-1-15 data-3-4)
           (SCRIPT-IO script8 data-2-7 data-0-1 data-3-12)
           (SCRIPT-IO script9 data-3-4 data-1-15 data-4-5)
           (SCRIPT-IO script10 data-3-4 data-0-11 data-4-8)
           (SCRIPT-IO script11 data-3-12 data-0-9 data-4-10)
           (SCRIPT-IO script12 data-3-4 data-2-3 data-4-14)
           (SCRIPT-IO script13 data-3-12 data-0-11 data-4-17)
           (SCRIPT-IO script14 data-3-12 data-1-2 data-4-18)
           (SCRIPT-IO script15 data-3-12 data-0-21 data-4-17)
           (SCRIPT-IO script16 data-3-12 data-0-19 data-4-8)
           (SCRIPT-IO script17 data-2-16 data-0-6 data-3-4)
           (SCRIPT-IO script18 data-1-2 data-1-15 data-2-20)
           (SCRIPT-IO script19 data-0-6 data-0-22 data-1-15)
           (SCRIPT-IO script20 data-1-2 data-0-1 data-2-20)
           (SCRIPT-IO script21 data-0-9 data-0-22 data-1-2)
           (SCRIPT-IO script22 data-2-3 data-0-9 data-3-4)
           (SCRIPT-IO script23 data-0-22 data-0-6 data-1-15)
           (SCRIPT-IO script24 data-2-3 data-2-7 data-3-12)
           ...
           (DATA-SIZE data-4-8 number2)
           (DATA-SIZE data-4-10 number4)
           ...
           (= (process-cost script4 server1) 29)
