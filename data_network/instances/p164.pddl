(define (problem p20-3-32-prob-20-3-32-tiny-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           (SCRIPT-IO script1 data-0-9 data-0-11 data-1-2)
           (SCRIPT-IO script2 data-0-4 data-0-12 data-1-5)
           (SCRIPT-IO script3 data-0-11 data-0-19 data-1-6)
           (SCRIPT-IO script4 data-0-1 data-0-13 data-1-8)
           (SCRIPT-IO script5 data-0-10 data-0-4 data-1-17)
           (SCRIPT-IO script6 data-0-10 data-0-9 data-1-18)
           (SCRIPT-IO script7 data-0-12 data-0-10 data-1-20)
           (SCRIPT-IO script8 data-1-8 data-0-14 data-2-3)
           (SCRIPT-IO script9 data-1-5 data-0-4 data-2-7)
           (SCRIPT-IO script10 data-1-5 data-0-19 data-2-15)
           (SCRIPT-IO script11 data-1-5 data-0-10 data-2-16)
           (SCRIPT-IO script12 data-0-12 data-0-1 data-1-18)
           (SCRIPT-IO script13 data-0-19 data-0-9 data-1-6)
           (SCRIPT-IO script14 data-1-8 data-0-11 data-2-3)
           (SCRIPT-IO script15 data-0-11 data-0-14 data-1-8)
           (SCRIPT-IO script16 data-1-6 data-0-11 data-2-16)
           (SCRIPT-IO script17 data-1-5 data-1-6 data-2-16)
           (SCRIPT-IO script18 data-1-17 data-0-19 data-2-16)
           (SCRIPT-IO script19 data-0-19 data-0-12 data-1-6)
           (SCRIPT-IO script20 data-1-20 data-0-9 data-2-16)
           (SCRIPT-IO script21 data-1-17 data-1-5 data-2-15)
           (SCRIPT-IO script22 data-0-10 data-0-14 data-1-5)
           (SCRIPT-IO script23 data-1-17 data-1-2 data-2-15)
           (SCRIPT-IO script24 data-1-20 data-1-6 data-2-16)
           (SCRIPT-IO script25 data-1-18 data-1-20 data-2-3)
           (SCRIPT-IO script26 data-0-12 data-0-14 data-1-2)
           (SCRIPT-IO script27 data-1-8 data-0-14 data-2-15)
           (SCRIPT-IO script28 data-1-20 data-1-8 data-2-7)
           (SCRIPT-IO script29 data-1-20 data-0-10 data-2-3)
           (SCRIPT-IO script30 data-0-1 data-0-14 data-1-18)
           (SCRIPT-IO script31 data-1-20 data-1-17 data-2-16)
           (SCRIPT-IO script32 data-0-4 data-0-14 data-1-2)
           ...
           (= (process-cost script3 server1) 33)
           (= (process-cost script3 server2) 12)
           (= (process-cost script3 server3) 4)
           ...
           (= (process-cost script24 server3) 5)
