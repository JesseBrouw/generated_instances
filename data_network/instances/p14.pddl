(define (problem p18-2-29-prob-18-2-29-ring-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           (SCRIPT-IO script1 data-0-14 data-0-3 data-1-2)
           (SCRIPT-IO script2 data-0-10 data-0-8 data-1-5)
           (SCRIPT-IO script3 data-0-3 data-0-13 data-1-6)
           (SCRIPT-IO script4 data-0-8 data-0-3 data-1-7)
           (SCRIPT-IO script5 data-0-15 data-0-1 data-1-9)
           (SCRIPT-IO script6 data-0-10 data-0-4 data-1-11)
           (SCRIPT-IO script7 data-0-10 data-0-1 data-1-12)
           (SCRIPT-IO script8 data-0-3 data-0-1 data-1-16)
           (SCRIPT-IO script9 data-0-13 data-0-15 data-1-17)
           (SCRIPT-IO script10 data-0-14 data-0-1 data-1-18)
           (SCRIPT-IO script11 data-0-10 data-0-4 data-1-18)
           (SCRIPT-IO script12 data-0-3 data-0-13 data-1-12)
           (SCRIPT-IO script13 data-0-3 data-0-14 data-1-9)
           (SCRIPT-IO script14 data-0-4 data-0-13 data-1-7)
           (SCRIPT-IO script15 data-0-10 data-0-3 data-1-18)
           (SCRIPT-IO script16 data-0-8 data-0-13 data-1-6)
           (SCRIPT-IO script17 data-0-10 data-0-8 data-1-7)
           (SCRIPT-IO script18 data-0-4 data-0-13 data-1-11)
           (SCRIPT-IO script19 data-0-15 data-0-13 data-1-16)
           (SCRIPT-IO script20 data-0-15 data-0-3 data-1-5)
           (SCRIPT-IO script21 data-0-4 data-0-14 data-1-5)
           (SCRIPT-IO script22 data-0-4 data-0-3 data-1-9)
           (SCRIPT-IO script23 data-0-4 data-0-13 data-1-17)
           (SCRIPT-IO script24 data-0-8 data-0-15 data-1-2)
           (SCRIPT-IO script25 data-0-15 data-0-13 data-1-18)
           (SCRIPT-IO script26 data-0-4 data-0-3 data-1-16)
           (SCRIPT-IO script27 data-0-10 data-0-3 data-1-11)
           (SCRIPT-IO script28 data-0-14 data-0-15 data-1-2)
           (SCRIPT-IO script29 data-0-15 data-0-4 data-1-11)
           ...
           (= (process-cost script22 server5) 10)
           ...
           (= (process-cost script23 server4) 28)
           ...
           (= (process-cost script29 server5) 29)
    ...
    (:goal
           (and
                ...
                (saved data-1-7 server6)
                (saved data-1-9 server3)
                (saved data-1-11 server1)
                (saved data-1-12 server4)
                (saved data-1-16 server5)
                (saved data-1-17 server6)
                (saved data-1-18 server5)
           )
    )
