(define (problem p26-4-28-prob-26-4-28-ring-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (= (process-cost script5 server4) 36)
           ...
           (= (process-cost script7 server7) 10)
           ...
           (= (process-cost script9 server3) 33)
           ...
           (= (process-cost script11 server2) 30)
           ...
           (= (process-cost script17 server6) 9)
