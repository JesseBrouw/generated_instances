(define (problem p47-5-72-prob-47-5-72-tiny-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           (SCRIPT-IO script1 data-0-6 data-0-41 data-1-2)
           (SCRIPT-IO script2 data-0-26 data-0-44 data-1-20)
           (SCRIPT-IO script3 data-0-14 data-0-11 data-1-24)
           (SCRIPT-IO script4 data-0-22 data-0-44 data-1-27)
           (SCRIPT-IO script5 data-0-6 data-0-14 data-1-28)
           (SCRIPT-IO script6 data-0-41 data-0-44 data-1-29)
           (SCRIPT-IO script7 data-1-2 data-0-36 data-2-3)
           (SCRIPT-IO script8 data-1-24 data-1-28 data-2-7)
           (SCRIPT-IO script9 data-1-28 data-1-27 data-2-12)
           (SCRIPT-IO script10 data-1-24 data-1-20 data-2-13)
           (SCRIPT-IO script11 data-1-20 data-0-6 data-2-16)
           (SCRIPT-IO script12 data-1-27 data-0-1 data-2-18)
           (SCRIPT-IO script13 data-1-20 data-0-45 data-2-23)
           (SCRIPT-IO script14 data-1-27 data-0-1 data-2-30)
           (SCRIPT-IO script15 data-1-2 data-1-27 data-2-32)
           (SCRIPT-IO script16 data-1-24 data-0-17 data-2-35)
           (SCRIPT-IO script17 data-1-24 data-1-27 data-2-37)
           (SCRIPT-IO script18 data-1-29 data-0-11 data-2-46)
           (SCRIPT-IO script19 data-2-7 data-0-44 data-3-4)
           (SCRIPT-IO script20 data-2-23 data-0-44 data-3-8)
           (SCRIPT-IO script21 data-2-7 data-1-27 data-3-10)
           (SCRIPT-IO script22 data-2-30 data-0-40 data-3-21)
           (SCRIPT-IO script23 data-2-37 data-1-29 data-3-33)
           (SCRIPT-IO script24 data-2-35 data-2-3 data-3-38)
           (SCRIPT-IO script25 data-2-37 data-0-14 data-3-39)
           (SCRIPT-IO script26 data-2-23 data-1-29 data-3-42)
           (SCRIPT-IO script27 data-2-32 data-1-20 data-3-43)
           (SCRIPT-IO script28 data-2-18 data-0-9 data-3-47)
           (SCRIPT-IO script29 data-3-42 data-0-26 data-4-5)
           (SCRIPT-IO script30 data-3-21 data-3-33 data-4-15)
           (SCRIPT-IO script31 data-3-43 data-2-13 data-4-19)
           (SCRIPT-IO script32 data-3-43 data-0-45 data-4-25)
           (SCRIPT-IO script33 data-3-38 data-1-27 data-4-31)
           (SCRIPT-IO script34 data-3-21 data-3-10 data-4-34)
           (SCRIPT-IO script35 data-2-18 data-1-28 data-3-38)
           (SCRIPT-IO script36 data-0-45 data-0-17 data-1-20)
           (SCRIPT-IO script37 data-0-14 data-0-36 data-1-29)
           (SCRIPT-IO script38 data-2-30 data-1-20 data-3-21)
           (SCRIPT-IO script39 data-1-29 data-0-22 data-2-16)
           (SCRIPT-IO script40 data-1-29 data-1-20 data-2-3)
           (SCRIPT-IO script41 data-2-3 data-1-24 data-3-42)
           (SCRIPT-IO script42 data-1-24 data-0-22 data-2-16)
           (SCRIPT-IO script43 data-2-23 data-1-29 data-3-43)
           (SCRIPT-IO script44 data-1-20 data-0-40 data-2-18)
           (SCRIPT-IO script45 data-3-21 data-0-22 data-4-5)
           (SCRIPT-IO script46 data-0-41 data-0-45 data-1-24)
           (SCRIPT-IO script47 data-3-42 data-2-18 data-4-31)
           (SCRIPT-IO script48 data-1-29 data-0-26 data-2-13)
           (SCRIPT-IO script49 data-0-6 data-0-9 data-1-29)
           (SCRIPT-IO script50 data-0-11 data-0-41 data-1-27)
           (SCRIPT-IO script51 data-2-12 data-1-2 data-3-8)
           (SCRIPT-IO script52 data-3-21 data-1-24 data-4-34)
           (SCRIPT-IO script53 data-2-46 data-1-24 data-3-43)
           (SCRIPT-IO script54 data-3-21 data-0-1 data-4-25)
           (SCRIPT-IO script55 data-0-22 data-0-9 data-1-28)
           (SCRIPT-IO script56 data-2-35 data-1-20 data-3-42)
           (SCRIPT-IO script57 data-1-27 data-0-36 data-2-35)
           (SCRIPT-IO script58 data-0-36 data-0-17 data-1-24)
           (SCRIPT-IO script59 data-3-43 data-2-13 data-4-34)
           (SCRIPT-IO script60 data-2-7 data-0-22 data-3-39)
           (SCRIPT-IO script61 data-1-20 data-1-24 data-2-12)
           (SCRIPT-IO script62 data-2-46 data-1-27 data-3-39)
           (SCRIPT-IO script63 data-1-28 data-1-27 data-2-37)
           (SCRIPT-IO script64 data-1-28 data-0-9 data-2-37)
           (SCRIPT-IO script65 data-3-10 data-0-41 data-4-25)
           (SCRIPT-IO script66 data-2-37 data-1-2 data-3-21)
           (SCRIPT-IO script67 data-0-41 data-0-44 data-1-29)
           (SCRIPT-IO script68 data-2-12 data-1-24 data-3-8)
           (SCRIPT-IO script69 data-2-13 data-2-23 data-3-8)
           (SCRIPT-IO script70 data-1-20 data-0-14 data-2-13)
           (SCRIPT-IO script71 data-2-18 data-1-27 data-3-42)
           (SCRIPT-IO script72 data-0-40 data-0-6 data-1-27)
           ...
           (DATA-SIZE data-3-8 number2)
           (DATA-SIZE data-3-10 number3)
           (DATA-SIZE data-3-21 number3)
           (DATA-SIZE data-3-33 number5)
           (DATA-SIZE data-3-38 number3)
           (DATA-SIZE data-3-39 number2)
           (DATA-SIZE data-3-42 number1)
           (DATA-SIZE data-3-43 number3)
           (DATA-SIZE data-3-47 number5)
           (DATA-SIZE data-4-5 number4)
           (DATA-SIZE data-4-15 number5)
           (DATA-SIZE data-4-19 number3)
           (DATA-SIZE data-4-25 number5)
           (DATA-SIZE data-4-31 number5)
           (DATA-SIZE data-4-34 number3)
           ...
           (= (process-cost script11 server3) 5)
           ...
           (= (process-cost script16 server3) 6)
           ...
           (= (process-cost script19 server1) 14)
           ...
           (= (process-cost script21 server1) 29)
           ...
           (= (process-cost script27 server3) 4)
           ...
           (= (process-cost script43 server1) 25)
           (= (process-cost script43 server2) 12)
           (= (process-cost script43 server3) 13)
           (= (process-cost script44 server1) 16)
           ...
           (= (process-cost script56 server1) 23)
           ...
           (= (process-cost script65 server1) 15)
           (= (process-cost script65 server2) 10)
           (= (process-cost script65 server3) 9)
           (= (process-cost script66 server1) 15)
           (= (process-cost script66 server2) 11)
           (= (process-cost script66 server3) 13)
           ...
           (= (process-cost script71 server1) 14)
    ...
    (:goal
           (and
                ...
                (saved data-3-39 server1)
                (saved data-3-47 server1)
                (saved data-4-5 server1)
                (saved data-4-15 server1)
                (saved data-4-19 server3)
                (saved data-4-25 server1)
                (saved data-4-31 server3)
                (saved data-4-34 server1)
           )
    )
