(define (problem p38-4-40-prob-38-4-40-small-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (= (process-cost script7 server4) 6)
    ...
    (:goal
           (and
                ...
                (saved data-3-29 server1)
                (saved data-3-30 server2)
                (saved data-3-36 server2)
                (saved data-3-37 server3)
           )
    )
