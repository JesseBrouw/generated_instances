(define (problem p22-4-35-prob-22-4-35-ring-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (= (process-cost script12 server6) 11)
           ...
           (= (process-cost script15 server7) 11)
    ...
    (:goal
           (and
                (saved data-1-6 server6)
                (saved data-1-16 server5)
