(define (problem p6-2-11-prob-6-2-11-ring-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (SCRIPT-IO script9 data-0-6 data-0-4 data-1-5)
           (SCRIPT-IO script10 data-0-4 data-0-3 data-1-2)
           (SCRIPT-IO script11 data-0-3 data-0-6 data-1-5)
