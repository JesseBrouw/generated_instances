(define (problem p32-5-34-prob-32-5-34-tiny-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           (SCRIPT-IO script1 data-0-6 data-0-26 data-1-2)
           (SCRIPT-IO script2 data-0-20 data-0-6 data-1-21)
           (SCRIPT-IO script3 data-0-20 data-0-11 data-1-23)
           (SCRIPT-IO script4 data-0-6 data-0-29 data-1-25)
           (SCRIPT-IO script5 data-0-26 data-0-11 data-1-31)
           (SCRIPT-IO script6 data-1-2 data-1-25 data-2-3)
           (SCRIPT-IO script7 data-1-21 data-0-29 data-2-10)
           (SCRIPT-IO script8 data-1-21 data-0-6 data-2-13)
           (SCRIPT-IO script9 data-1-21 data-0-6 data-2-14)
           (SCRIPT-IO script10 data-1-21 data-1-23 data-2-15)
           (SCRIPT-IO script11 data-1-31 data-1-2 data-2-16)
           (SCRIPT-IO script12 data-1-31 data-0-6 data-2-28)
           (SCRIPT-IO script13 data-1-25 data-0-26 data-2-30)
           (SCRIPT-IO script14 data-1-31 data-0-26 data-2-32)
           (SCRIPT-IO script15 data-2-28 data-1-21 data-3-4)
           (SCRIPT-IO script16 data-2-16 data-0-26 data-3-8)
           (SCRIPT-IO script17 data-3-4 data-1-2 data-4-5)
           (SCRIPT-IO script18 data-3-4 data-0-26 data-4-7)
           (SCRIPT-IO script19 data-3-8 data-1-31 data-4-9)
           (SCRIPT-IO script20 data-3-8 data-0-26 data-4-12)
           (SCRIPT-IO script21 data-3-4 data-3-8 data-4-17)
           (SCRIPT-IO script22 data-3-8 data-3-4 data-4-18)
           (SCRIPT-IO script23 data-3-8 data-2-16 data-4-19)
           (SCRIPT-IO script24 data-3-4 data-3-8 data-4-22)
           (SCRIPT-IO script25 data-3-8 data-1-21 data-4-24)
           (SCRIPT-IO script26 data-3-4 data-1-31 data-4-27)
           (SCRIPT-IO script27 data-3-4 data-3-8 data-4-18)
           (SCRIPT-IO script28 data-1-2 data-0-20 data-2-3)
           (SCRIPT-IO script29 data-2-32 data-2-16 data-3-8)
           (SCRIPT-IO script30 data-2-16 data-2-10 data-3-4)
           (SCRIPT-IO script31 data-1-25 data-0-11 data-2-13)
           (SCRIPT-IO script32 data-0-26 data-0-29 data-1-25)
           (SCRIPT-IO script33 data-0-6 data-0-29 data-1-25)
           (SCRIPT-IO script34 data-3-4 data-0-26 data-4-24)
           ...
           (DATA-SIZE data-3-8 number3)
           (DATA-SIZE data-4-5 number4)
           (DATA-SIZE data-4-7 number1)
           (DATA-SIZE data-4-9 number3)
           (DATA-SIZE data-4-12 number1)
           (DATA-SIZE data-4-17 number4)
           (DATA-SIZE data-4-18 number1)
           (DATA-SIZE data-4-19 number4)
           (DATA-SIZE data-4-22 number5)
           (DATA-SIZE data-4-24 number4)
           (DATA-SIZE data-4-27 number5)
           ...
           (= (process-cost script26 server3) 4)
    ...
    (:goal
           (and
                ...
                (saved data-4-9 server2)
                (saved data-4-12 server3)
                (saved data-4-17 server2)
                (saved data-4-18 server2)
                (saved data-4-19 server2)
                (saved data-4-22 server1)
                (saved data-4-24 server2)
                (saved data-4-27 server3)
           )
    )
