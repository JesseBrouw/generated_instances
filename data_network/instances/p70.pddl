(define (problem p6-2-8-prob-6-2-8-small-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (SCRIPT-IO script6 data-0-1 data-0-3 data-1-5)
           (SCRIPT-IO script7 data-0-1 data-0-3 data-1-2)
           (SCRIPT-IO script8 data-0-3 data-0-1 data-1-5)
