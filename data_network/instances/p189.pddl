(define (problem p7-5-9-prob-7-5-9-tiny-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (SCRIPT-IO script4 data-2-3 data-0-6 data-3-7)
           (SCRIPT-IO script5 data-3-7 data-1-2 data-4-5)
           (SCRIPT-IO script6 data-3-4 data-0-1 data-4-5)
           (SCRIPT-IO script7 data-0-1 data-0-6 data-1-2)
           (SCRIPT-IO script8 data-2-3 data-0-6 data-3-4)
           (SCRIPT-IO script9 data-2-3 data-1-2 data-3-7)
