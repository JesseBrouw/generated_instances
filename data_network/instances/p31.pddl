(define (problem p29-3-31-prob-29-3-31-ring-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           (SCRIPT-IO script1 data-0-14 data-0-13 data-1-2)
           (SCRIPT-IO script2 data-0-7 data-0-28 data-1-6)
           (SCRIPT-IO script3 data-0-4 data-0-5 data-1-15)
           (SCRIPT-IO script4 data-0-25 data-0-5 data-1-16)
           (SCRIPT-IO script5 data-0-26 data-0-25 data-1-17)
           (SCRIPT-IO script6 data-0-13 data-0-25 data-1-20)
           (SCRIPT-IO script7 data-0-7 data-0-1 data-1-21)
           (SCRIPT-IO script8 data-0-25 data-0-26 data-1-22)
           (SCRIPT-IO script9 data-0-5 data-0-1 data-1-23)
           (SCRIPT-IO script10 data-0-5 data-0-7 data-1-24)
           (SCRIPT-IO script11 data-0-13 data-0-25 data-1-27)
           (SCRIPT-IO script12 data-1-2 data-1-17 data-2-3)
           (SCRIPT-IO script13 data-1-6 data-0-7 data-2-8)
           (SCRIPT-IO script14 data-1-20 data-1-6 data-2-9)
           (SCRIPT-IO script15 data-1-20 data-1-6 data-2-10)
           (SCRIPT-IO script16 data-1-21 data-0-4 data-2-11)
           (SCRIPT-IO script17 data-1-15 data-0-25 data-2-12)
           (SCRIPT-IO script18 data-1-6 data-0-25 data-2-18)
           (SCRIPT-IO script19 data-1-24 data-1-15 data-2-19)
           (SCRIPT-IO script20 data-1-27 data-0-1 data-2-29)
           (SCRIPT-IO script21 data-1-24 data-1-27 data-2-18)
           (SCRIPT-IO script22 data-0-5 data-0-26 data-1-24)
           (SCRIPT-IO script23 data-0-26 data-0-14 data-1-15)
           (SCRIPT-IO script24 data-0-7 data-0-1 data-1-27)
           (SCRIPT-IO script25 data-1-22 data-1-2 data-2-29)
           (SCRIPT-IO script26 data-1-27 data-0-4 data-2-10)
           (SCRIPT-IO script27 data-0-7 data-0-13 data-1-24)
           (SCRIPT-IO script28 data-1-15 data-0-4 data-2-29)
           (SCRIPT-IO script29 data-0-7 data-0-4 data-1-17)
           (SCRIPT-IO script30 data-0-26 data-0-4 data-1-23)
           (SCRIPT-IO script31 data-1-15 data-0-26 data-2-29)
           ...
           (= (process-cost script12 server5) 27)
           ...
           (= (process-cost script25 server5) 26)
           ...
           (= (process-cost script27 server3) 31)
           ...
           (= (process-cost script28 server6) 27)
    ...
    (:goal
           (and
                (saved data-1-16 server6)
                (saved data-1-23 server1)
