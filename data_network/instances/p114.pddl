(define (problem p22-5-24-prob-22-5-24-ring-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (= (process-cost script13 server2) 29)
           ...
           (= (process-cost script15 server3) 29)
    ...
    (:goal
           (and
                ...
                (saved data-1-10 server5)
                (saved data-1-15 server6)
                (saved data-4-5 server5)
                (saved data-4-14 server7)
           )
    )
