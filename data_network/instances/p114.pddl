(define (problem p30-4-32-prob-30-4-32-small-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (SCRIPT-IO script2 data-0-13 data-0-11 data-1-6)
           (SCRIPT-IO script3 data-0-1 data-0-23 data-1-10)
           (SCRIPT-IO script4 data-0-17 data-0-7 data-1-15)
           (SCRIPT-IO script5 data-0-11 data-0-13 data-1-19)
           (SCRIPT-IO script6 data-0-13 data-0-17 data-1-20)
           (SCRIPT-IO script7 data-0-11 data-0-7 data-1-24)
           (SCRIPT-IO script8 data-0-23 data-0-18 data-1-27)
           (SCRIPT-IO script9 data-0-1 data-0-7 data-1-28)
           (SCRIPT-IO script10 data-1-2 data-1-19 data-2-3)
           (SCRIPT-IO script11 data-1-19 data-0-18 data-2-8)
           (SCRIPT-IO script12 data-1-20 data-0-18 data-2-22)
           (SCRIPT-IO script13 data-1-2 data-0-17 data-2-25)
           (SCRIPT-IO script14 data-1-28 data-1-2 data-2-26)
           (SCRIPT-IO script15 data-1-28 data-0-17 data-2-29)
           (SCRIPT-IO script16 data-2-22 data-2-29 data-3-4)
           (SCRIPT-IO script17 data-2-25 data-1-20 data-3-12)
           (SCRIPT-IO script18 data-2-26 data-0-5 data-3-14)
           (SCRIPT-IO script19 data-2-3 data-2-22 data-3-16)
           (SCRIPT-IO script20 data-2-25 data-2-3 data-3-21)
           (SCRIPT-IO script21 data-2-25 data-2-29 data-3-30)
           (SCRIPT-IO script22 data-2-22 data-2-26 data-3-14)
           (SCRIPT-IO script23 data-1-27 data-0-11 data-2-3)
           (SCRIPT-IO script24 data-1-10 data-0-9 data-2-22)
           (SCRIPT-IO script25 data-0-23 data-0-7 data-1-15)
           (SCRIPT-IO script26 data-2-22 data-2-29 data-3-21)
           (SCRIPT-IO script27 data-2-26 data-0-17 data-3-16)
           (SCRIPT-IO script28 data-2-29 data-0-9 data-3-12)
           (SCRIPT-IO script29 data-0-23 data-0-1 data-1-28)
           (SCRIPT-IO script30 data-2-8 data-1-2 data-3-30)
           (SCRIPT-IO script31 data-2-25 data-1-2 data-3-21)
           (SCRIPT-IO script32 data-0-13 data-0-11 data-1-24)
    ...
    (:goal
           (and
                (saved data-1-6 server4)
                (saved data-1-15 server3)
                (saved data-1-24 server1)
