(define (problem p37-5-39-prob-37-5-39-tiny-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (= (process-cost script34 server1) 27)
           ...
           (= (process-cost script36 server3) 13)
