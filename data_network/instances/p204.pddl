(define (problem p42-5-65-prob-42-5-65-tiny-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           (SCRIPT-IO script1 data-0-1 data-0-24 data-1-2)
           (SCRIPT-IO script2 data-0-35 data-0-27 data-1-18)
           (SCRIPT-IO script3 data-0-7 data-0-6 data-1-20)
           (SCRIPT-IO script4 data-0-27 data-0-1 data-1-21)
           (SCRIPT-IO script5 data-0-25 data-0-1 data-1-32)
           (SCRIPT-IO script6 data-0-42 data-0-27 data-1-37)
           (SCRIPT-IO script7 data-0-7 data-0-24 data-1-38)
           (SCRIPT-IO script8 data-0-35 data-0-1 data-1-39)
           (SCRIPT-IO script9 data-1-21 data-1-39 data-2-3)
           (SCRIPT-IO script10 data-1-39 data-1-37 data-2-14)
           (SCRIPT-IO script11 data-1-20 data-1-2 data-2-16)
           (SCRIPT-IO script12 data-1-20 data-0-25 data-2-19)
           (SCRIPT-IO script13 data-1-20 data-0-25 data-2-28)
           (SCRIPT-IO script14 data-1-39 data-0-7 data-2-29)
           (SCRIPT-IO script15 data-1-2 data-0-7 data-2-31)
           (SCRIPT-IO script16 data-2-31 data-0-25 data-3-4)
           (SCRIPT-IO script17 data-2-29 data-2-14 data-3-8)
           (SCRIPT-IO script18 data-2-31 data-2-29 data-3-9)
           (SCRIPT-IO script19 data-2-16 data-1-37 data-3-10)
           (SCRIPT-IO script20 data-2-14 data-1-39 data-3-12)
           (SCRIPT-IO script21 data-2-31 data-2-19 data-3-13)
           (SCRIPT-IO script22 data-2-3 data-1-21 data-3-26)
           (SCRIPT-IO script23 data-2-3 data-1-21 data-3-30)
           (SCRIPT-IO script24 data-2-14 data-0-24 data-3-33)
           (SCRIPT-IO script25 data-2-19 data-2-3 data-3-36)
           (SCRIPT-IO script26 data-2-3 data-0-1 data-3-40)
           (SCRIPT-IO script27 data-3-10 data-1-32 data-4-5)
           (SCRIPT-IO script28 data-3-13 data-1-39 data-4-11)
           (SCRIPT-IO script29 data-3-30 data-2-28 data-4-15)
           (SCRIPT-IO script30 data-3-4 data-1-38 data-4-17)
           (SCRIPT-IO script31 data-3-8 data-1-20 data-4-22)
           (SCRIPT-IO script32 data-3-13 data-3-26 data-4-23)
           (SCRIPT-IO script33 data-3-30 data-2-29 data-4-34)
           (SCRIPT-IO script34 data-3-4 data-3-30 data-4-41)
           (SCRIPT-IO script35 data-3-4 data-1-18 data-4-23)
           (SCRIPT-IO script36 data-1-37 data-0-25 data-2-3)
           (SCRIPT-IO script37 data-1-32 data-0-7 data-2-3)
           (SCRIPT-IO script38 data-1-2 data-1-32 data-2-19)
           (SCRIPT-IO script39 data-1-21 data-0-1 data-2-29)
           (SCRIPT-IO script40 data-2-14 data-2-31 data-3-26)
           (SCRIPT-IO script41 data-0-7 data-0-35 data-1-20)
           (SCRIPT-IO script42 data-0-24 data-0-6 data-1-18)
           (SCRIPT-IO script43 data-1-2 data-0-27 data-2-29)
           (SCRIPT-IO script44 data-1-18 data-0-25 data-2-19)
           (SCRIPT-IO script45 data-0-1 data-0-42 data-1-38)
           (SCRIPT-IO script46 data-1-18 data-1-39 data-2-19)
           (SCRIPT-IO script47 data-1-2 data-0-27 data-2-29)
           (SCRIPT-IO script48 data-1-20 data-1-32 data-2-31)
           (SCRIPT-IO script49 data-3-26 data-0-1 data-4-41)
           (SCRIPT-IO script50 data-1-21 data-0-42 data-2-19)
           (SCRIPT-IO script51 data-1-20 data-1-38 data-2-19)
           (SCRIPT-IO script52 data-2-16 data-1-37 data-3-13)
           (SCRIPT-IO script53 data-2-28 data-1-38 data-3-8)
           (SCRIPT-IO script54 data-2-16 data-2-3 data-3-12)
           (SCRIPT-IO script55 data-1-21 data-1-32 data-2-28)
           (SCRIPT-IO script56 data-2-28 data-1-18 data-3-26)
           (SCRIPT-IO script57 data-1-37 data-1-38 data-2-28)
           (SCRIPT-IO script58 data-1-18 data-1-37 data-2-31)
           (SCRIPT-IO script59 data-1-20 data-1-2 data-2-14)
           (SCRIPT-IO script60 data-2-31 data-1-20 data-3-10)
           (SCRIPT-IO script61 data-1-21 data-0-27 data-2-29)
           (SCRIPT-IO script62 data-1-37 data-1-39 data-2-16)
           (SCRIPT-IO script63 data-3-8 data-3-36 data-4-34)
           (SCRIPT-IO script64 data-0-6 data-0-27 data-1-39)
           (SCRIPT-IO script65 data-3-10 data-2-3 data-4-5)
           ...
           (DATA-SIZE data-1-39 number1)
           (DATA-SIZE data-2-3 number3)
           (DATA-SIZE data-2-14 number5)
           ...
           (DATA-SIZE data-3-26 number2)
           (DATA-SIZE data-3-30 number4)
           (DATA-SIZE data-3-33 number1)
           (DATA-SIZE data-3-36 number4)
           (DATA-SIZE data-3-40 number5)
           (DATA-SIZE data-4-5 number4)
           (DATA-SIZE data-4-11 number1)
           (DATA-SIZE data-4-15 number4)
           (DATA-SIZE data-4-17 number4)
           (DATA-SIZE data-4-22 number2)
           (DATA-SIZE data-4-23 number3)
           (DATA-SIZE data-4-34 number2)
           (DATA-SIZE data-4-41 number5)
           ...
           (= (process-cost script10 server1) 25)
           ...
           (= (process-cost script25 server1) 16)
           ...
           (= (process-cost script36 server1) 28)
           ...
           (= (process-cost script44 server1) 26)
           ...
           (= (process-cost script45 server3) 13)
           ...
           (= (process-cost script57 server3) 13)
    ...
    (:goal
           (and
                ...
                (saved data-4-11 server1)
                (saved data-4-15 server3)
                (saved data-4-17 server2)
                (saved data-4-22 server3)
                (saved data-4-23 server3)
                (saved data-4-34 server3)
                (saved data-4-41 server2)
           )
    )
