(define (problem p14-4-16-prob-14-4-16-ring-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           (SCRIPT-IO script1 data-0-11 data-0-5 data-1-2)
           (SCRIPT-IO script2 data-0-8 data-0-1 data-1-10)
           (SCRIPT-IO script3 data-0-8 data-0-1 data-1-12)
           (SCRIPT-IO script4 data-1-2 data-0-11 data-2-3)
           (SCRIPT-IO script5 data-1-2 data-1-12 data-2-6)
           (SCRIPT-IO script6 data-1-2 data-0-11 data-2-9)
           (SCRIPT-IO script7 data-1-10 data-1-2 data-2-13)
           (SCRIPT-IO script8 data-2-13 data-0-1 data-3-4)
           (SCRIPT-IO script9 data-2-13 data-2-6 data-3-7)
           (SCRIPT-IO script10 data-2-6 data-2-9 data-3-14)
           (SCRIPT-IO script11 data-0-11 data-0-5 data-1-12)
           (SCRIPT-IO script12 data-2-13 data-0-5 data-3-14)
           (SCRIPT-IO script13 data-1-10 data-0-5 data-2-13)
           (SCRIPT-IO script14 data-1-12 data-0-8 data-2-3)
           (SCRIPT-IO script15 data-0-11 data-0-1 data-1-12)
           (SCRIPT-IO script16 data-1-2 data-0-11 data-2-3)
           ...
           (= (process-cost script16 server7) 28)
