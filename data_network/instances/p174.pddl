(define (problem p10-4-17-prob-10-4-17-tiny-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (SCRIPT-IO script3 data-1-2 data-0-7 data-2-8)
           (SCRIPT-IO script4 data-2-3 data-2-8 data-3-4)
           (SCRIPT-IO script5 data-0-10 data-0-6 data-1-2)
           (SCRIPT-IO script6 data-1-2 data-0-1 data-2-8)
           (SCRIPT-IO script7 data-2-3 data-0-7 data-3-4)
           (SCRIPT-IO script8 data-1-2 data-0-9 data-2-8)
           (SCRIPT-IO script9 data-0-9 data-0-5 data-1-2)
           (SCRIPT-IO script10 data-2-3 data-1-2 data-3-4)
           (SCRIPT-IO script11 data-1-2 data-0-7 data-2-3)
           (SCRIPT-IO script12 data-0-9 data-0-6 data-1-2)
           (SCRIPT-IO script13 data-2-8 data-1-2 data-3-4)
           (SCRIPT-IO script14 data-1-2 data-0-6 data-2-3)
           (SCRIPT-IO script15 data-1-2 data-0-6 data-2-3)
           (SCRIPT-IO script16 data-2-8 data-0-6 data-3-4)
           (SCRIPT-IO script17 data-1-2 data-0-6 data-2-8)
