(define (problem p27-5-29-prob-27-5-29-ring-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (= (process-cost script5 server3) 33)
           ...
           (= (process-cost script11 server6) 27)
           ...
           (= (process-cost script24 server5) 28)
