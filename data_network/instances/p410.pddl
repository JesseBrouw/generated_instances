(define (problem p47-5-49-prob-47-5-49-tiny-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (= (process-cost script4 server3) 4)
    ...
    (:goal
           (and
                (saved data-3-24 server1)
                (saved data-4-5 server1)
                (saved data-4-7 server1)
                (saved data-4-13 server3)
                (saved data-4-21 server3)
                (saved data-4-31 server1)
                (saved data-4-40 server3)
                (saved data-4-42 server3)
                (saved data-4-47 server2)
           )
    )
