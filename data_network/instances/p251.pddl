(define (problem p17-5-27-prob-17-5-27-small-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (= (process-cost script9 server4) 5)
           ...
           (= (process-cost script23 server3) 5)
