(define (problem p26-4-41-prob-26-4-41-ring-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (= (process-cost script5 server4) 27)
           ...
           (= (process-cost script7 server5) 11)
           ...
           (= (process-cost script17 server5) 28)
           ...
           (= (process-cost script28 server6) 16)
           ...
           (= (process-cost script41 server6) 10)
    ...
    (:goal
           (and
                ...
                (saved data-3-16 server7)
                (saved data-3-17 server5)
                (saved data-3-19 server2)
                (saved data-3-20 server5)
                (saved data-3-26 server7)
           )
    )
