(define (problem p32-5-34-prob-32-5-34-ring-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (= (process-cost script1 server5) 30)
           ...
           (= (process-cost script6 server4) 14)
           ...
           (= (process-cost script12 server5) 12)
           ...
           (= (process-cost script20 server6) 29)
           ...
           (= (process-cost script22 server6) 28)
    ...
    (:goal
           (and
                ...
                (saved data-4-7 server7)
                (saved data-4-21 server6)
