(define (problem p26-4-28-prob-26-4-28-tiny-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           (SCRIPT-IO script1 data-0-5 data-0-11 data-1-2)
           (SCRIPT-IO script2 data-0-15 data-0-14 data-1-6)
           (SCRIPT-IO script3 data-0-1 data-0-7 data-1-8)
           (SCRIPT-IO script4 data-0-10 data-0-11 data-1-9)
           (SCRIPT-IO script5 data-0-10 data-0-7 data-1-12)
           (SCRIPT-IO script6 data-0-10 data-0-5 data-1-19)
           (SCRIPT-IO script7 data-0-16 data-0-7 data-1-20)
           (SCRIPT-IO script8 data-0-14 data-0-10 data-1-21)
           (SCRIPT-IO script9 data-0-7 data-0-14 data-1-22)
           (SCRIPT-IO script10 data-1-19 data-0-7 data-2-3)
           (SCRIPT-IO script11 data-1-20 data-0-16 data-2-25)
           (SCRIPT-IO script12 data-2-3 data-0-5 data-3-4)
           (SCRIPT-IO script13 data-2-3 data-2-25 data-3-13)
           (SCRIPT-IO script14 data-2-3 data-0-1 data-3-17)
           (SCRIPT-IO script15 data-2-25 data-0-11 data-3-18)
           (SCRIPT-IO script16 data-2-3 data-2-25 data-3-23)
           (SCRIPT-IO script17 data-2-3 data-0-15 data-3-24)
           (SCRIPT-IO script18 data-2-25 data-0-1 data-3-26)
           (SCRIPT-IO script19 data-0-15 data-0-11 data-1-19)
           (SCRIPT-IO script20 data-2-25 data-1-6 data-3-17)
           (SCRIPT-IO script21 data-2-3 data-2-25 data-3-24)
           (SCRIPT-IO script22 data-2-3 data-2-25 data-3-4)
           (SCRIPT-IO script23 data-0-11 data-0-14 data-1-19)
           (SCRIPT-IO script24 data-2-25 data-1-6 data-3-17)
           (SCRIPT-IO script25 data-0-16 data-0-7 data-1-6)
           (SCRIPT-IO script26 data-1-19 data-1-8 data-2-3)
           (SCRIPT-IO script27 data-1-21 data-0-11 data-2-25)
           (SCRIPT-IO script28 data-0-14 data-0-15 data-1-12)
           ...
           (= (process-cost script26 server1) 16)
    ...
    (:goal
           (and
                ...
                (saved data-1-9 server2)
                (saved data-1-12 server2)
                (saved data-1-22 server2)
