(define (problem p23-3-25-prob-23-3-25-small-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           (SCRIPT-IO script1 data-0-15 data-0-4 data-1-2)
           (SCRIPT-IO script2 data-0-4 data-0-13 data-1-7)
           (SCRIPT-IO script3 data-0-22 data-0-23 data-1-8)
           (SCRIPT-IO script4 data-0-17 data-0-14 data-1-12)
           (SCRIPT-IO script5 data-0-23 data-0-17 data-1-18)
           (SCRIPT-IO script6 data-0-14 data-0-13 data-1-19)
           (SCRIPT-IO script7 data-0-1 data-0-14 data-1-20)
           (SCRIPT-IO script8 data-1-8 data-1-18 data-2-3)
           (SCRIPT-IO script9 data-1-18 data-0-15 data-2-5)
           (SCRIPT-IO script10 data-1-18 data-1-20 data-2-6)
           (SCRIPT-IO script11 data-1-8 data-0-14 data-2-9)
           (SCRIPT-IO script12 data-1-12 data-1-18 data-2-10)
           (SCRIPT-IO script13 data-1-8 data-1-12 data-2-11)
           (SCRIPT-IO script14 data-0-22 data-0-17 data-1-12)
           (SCRIPT-IO script15 data-1-19 data-0-4 data-2-10)
           (SCRIPT-IO script16 data-1-2 data-0-17 data-2-6)
           (SCRIPT-IO script17 data-0-21 data-0-14 data-1-7)
           (SCRIPT-IO script18 data-1-12 data-1-2 data-2-10)
           (SCRIPT-IO script19 data-0-23 data-0-17 data-1-20)
           (SCRIPT-IO script20 data-1-12 data-0-21 data-2-5)
           (SCRIPT-IO script21 data-1-12 data-0-15 data-2-10)
           (SCRIPT-IO script22 data-0-13 data-0-4 data-1-19)
           (SCRIPT-IO script23 data-1-7 data-1-20 data-2-11)
           (SCRIPT-IO script24 data-0-17 data-0-14 data-1-8)
           (SCRIPT-IO script25 data-0-23 data-0-1 data-1-20)
