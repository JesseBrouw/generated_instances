(define (problem p10-4-17-prob-10-4-17-ring-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           (SCRIPT-IO script1 data-0-7 data-0-8 data-1-2)
           (SCRIPT-IO script2 data-0-6 data-0-7 data-1-9)
           (SCRIPT-IO script3 data-1-9 data-1-2 data-2-3)
           (SCRIPT-IO script4 data-2-3 data-1-2 data-3-4)
           (SCRIPT-IO script5 data-2-3 data-0-7 data-3-10)
           (SCRIPT-IO script6 data-1-2 data-0-7 data-2-3)
           (SCRIPT-IO script7 data-1-9 data-0-1 data-2-3)
           (SCRIPT-IO script8 data-0-8 data-0-6 data-1-2)
           (SCRIPT-IO script9 data-0-5 data-0-1 data-1-2)
           (SCRIPT-IO script10 data-2-3 data-1-9 data-3-10)
           (SCRIPT-IO script11 data-0-5 data-0-1 data-1-9)
           (SCRIPT-IO script12 data-2-3 data-1-9 data-3-10)
           (SCRIPT-IO script13 data-1-2 data-0-6 data-2-3)
           (SCRIPT-IO script14 data-2-3 data-0-7 data-3-10)
           (SCRIPT-IO script15 data-0-6 data-0-1 data-1-2)
           (SCRIPT-IO script16 data-0-6 data-0-1 data-1-2)
           (SCRIPT-IO script17 data-2-3 data-1-2 data-3-4)
           ...
           (= (process-cost script14 server2) 27)
