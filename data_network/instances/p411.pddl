(define (problem p47-5-49-prob-47-5-49-tiny-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (= (process-cost script21 server1) 36)
           ...
           (= (process-cost script36 server3) 6)
           ...
           (= (process-cost script40 server2) 4)
           ...
           (= (process-cost script45 server2) 5)
