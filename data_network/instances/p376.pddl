(define (problem p38-4-59-prob-38-4-59-tiny-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           (SCRIPT-IO script1 data-0-24 data-0-15 data-1-2)
           (SCRIPT-IO script2 data-0-17 data-0-33 data-1-7)
           (SCRIPT-IO script3 data-0-12 data-0-18 data-1-8)
           (SCRIPT-IO script4 data-0-25 data-0-1 data-1-9)
           (SCRIPT-IO script5 data-0-11 data-0-24 data-1-13)
           (SCRIPT-IO script6 data-0-24 data-0-33 data-1-19)
           (SCRIPT-IO script7 data-0-24 data-0-12 data-1-21)
           (SCRIPT-IO script8 data-0-1 data-0-25 data-1-26)
           (SCRIPT-IO script9 data-0-24 data-0-5 data-1-32)
           (SCRIPT-IO script10 data-0-5 data-0-12 data-1-35)
           (SCRIPT-IO script11 data-1-2 data-0-18 data-2-3)
           (SCRIPT-IO script12 data-1-13 data-1-21 data-2-6)
           (SCRIPT-IO script13 data-1-8 data-0-17 data-2-16)
           (SCRIPT-IO script14 data-1-26 data-1-32 data-2-22)
           (SCRIPT-IO script15 data-1-13 data-0-15 data-2-28)
           (SCRIPT-IO script16 data-1-26 data-1-13 data-2-31)
           (SCRIPT-IO script17 data-1-35 data-0-11 data-2-34)
           (SCRIPT-IO script18 data-1-2 data-1-26 data-2-38)
           (SCRIPT-IO script19 data-2-28 data-1-26 data-3-4)
           (SCRIPT-IO script20 data-2-6 data-0-15 data-3-10)
           (SCRIPT-IO script21 data-2-3 data-0-5 data-3-14)
           (SCRIPT-IO script22 data-2-34 data-0-33 data-3-20)
           (SCRIPT-IO script23 data-2-3 data-2-22 data-3-23)
           (SCRIPT-IO script24 data-2-6 data-2-28 data-3-27)
           (SCRIPT-IO script25 data-2-28 data-2-16 data-3-29)
           (SCRIPT-IO script26 data-2-34 data-0-33 data-3-30)
           (SCRIPT-IO script27 data-2-16 data-2-34 data-3-36)
           (SCRIPT-IO script28 data-2-16 data-0-18 data-3-37)
           (SCRIPT-IO script29 data-1-13 data-0-1 data-2-6)
           (SCRIPT-IO script30 data-2-31 data-1-8 data-3-27)
           (SCRIPT-IO script31 data-1-13 data-0-1 data-2-31)
           (SCRIPT-IO script32 data-1-35 data-1-26 data-2-3)
           (SCRIPT-IO script33 data-0-12 data-0-33 data-1-35)
           (SCRIPT-IO script34 data-1-13 data-0-18 data-2-34)
           (SCRIPT-IO script35 data-1-32 data-1-35 data-2-3)
           (SCRIPT-IO script36 data-2-31 data-1-13 data-3-30)
           (SCRIPT-IO script37 data-1-19 data-0-5 data-2-3)
           (SCRIPT-IO script38 data-1-32 data-0-24 data-2-38)
           (SCRIPT-IO script39 data-0-15 data-0-11 data-1-9)
           (SCRIPT-IO script40 data-2-31 data-1-7 data-3-4)
           (SCRIPT-IO script41 data-2-22 data-0-18 data-3-23)
           (SCRIPT-IO script42 data-0-11 data-0-25 data-1-26)
           (SCRIPT-IO script43 data-1-2 data-0-15 data-2-22)
           (SCRIPT-IO script44 data-1-35 data-0-12 data-2-16)
           (SCRIPT-IO script45 data-0-15 data-0-12 data-1-7)
           (SCRIPT-IO script46 data-2-38 data-1-9 data-3-29)
           (SCRIPT-IO script47 data-2-28 data-0-12 data-3-23)
           (SCRIPT-IO script48 data-0-17 data-0-18 data-1-9)
           (SCRIPT-IO script49 data-1-7 data-1-2 data-2-38)
           (SCRIPT-IO script50 data-2-3 data-2-34 data-3-14)
           (SCRIPT-IO script51 data-1-2 data-0-15 data-2-28)
           (SCRIPT-IO script52 data-2-38 data-1-21 data-3-10)
           (SCRIPT-IO script53 data-2-16 data-1-21 data-3-37)
           (SCRIPT-IO script54 data-1-2 data-0-11 data-2-34)
           (SCRIPT-IO script55 data-2-34 data-0-18 data-3-37)
           (SCRIPT-IO script56 data-0-33 data-0-1 data-1-9)
           (SCRIPT-IO script57 data-0-15 data-0-24 data-1-9)
           (SCRIPT-IO script58 data-2-34 data-0-12 data-3-27)
           (SCRIPT-IO script59 data-0-1 data-0-18 data-1-32)
           ...
           (= (process-cost script13 server1) 16)
           ...
           (= (process-cost script22 server2) 5)
           ...
           (= (process-cost script28 server1) 27)
           ...
           (= (process-cost script32 server2) 5)
           ...
           (= (process-cost script37 server1) 27)
           ...
           (= (process-cost script47 server3) 11)
           ...
           (= (process-cost script50 server3) 13)
           ...
           (= (process-cost script54 server1) 15)
           ...
           (= (process-cost script57 server1) 13)
           ...
           (= (process-cost script59 server1) 24)
    ...
    (:goal
           (and
                ...
                (saved data-3-23 server2)
                (saved data-3-27 server3)
                (saved data-3-29 server3)
                (saved data-3-30 server3)
                (saved data-3-36 server2)
                (saved data-3-37 server1)
           )
    )
