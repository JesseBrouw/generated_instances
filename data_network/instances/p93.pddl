(define (problem p30-4-47-prob-30-4-47-ring-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (= (process-cost script2 server7) 10)
           ...
           (= (process-cost script20 server4) 28)
           ...
           (= (process-cost script35 server6) 7)
           ...
           (= (process-cost script37 server1) 5)
    ...
    (:goal
           (and
                ...
                (saved data-3-15 server7)
                (saved data-3-21 server2)
                (saved data-3-25 server5)
           )
    )
