(define (problem p29-3-31-prob-29-3-31-small-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           (SCRIPT-IO script1 data-0-11 data-0-4 data-1-2)
           (SCRIPT-IO script2 data-0-7 data-0-6 data-1-5)
           (SCRIPT-IO script3 data-0-11 data-0-27 data-1-10)
           (SCRIPT-IO script4 data-0-23 data-0-27 data-1-12)
           (SCRIPT-IO script5 data-0-23 data-0-27 data-1-13)
           (SCRIPT-IO script6 data-0-1 data-0-27 data-1-15)
           (SCRIPT-IO script7 data-0-8 data-0-4 data-1-17)
           (SCRIPT-IO script8 data-0-6 data-0-1 data-1-18)
           (SCRIPT-IO script9 data-0-1 data-0-11 data-1-19)
           (SCRIPT-IO script10 data-0-11 data-0-16 data-1-25)
           (SCRIPT-IO script11 data-0-20 data-0-27 data-1-26)
           (SCRIPT-IO script12 data-0-6 data-0-27 data-1-29)
           (SCRIPT-IO script13 data-1-12 data-0-7 data-2-3)
           (SCRIPT-IO script14 data-1-19 data-0-23 data-2-9)
           (SCRIPT-IO script15 data-1-15 data-0-23 data-2-14)
           (SCRIPT-IO script16 data-1-10 data-1-18 data-2-21)
           (SCRIPT-IO script17 data-1-12 data-0-8 data-2-22)
           (SCRIPT-IO script18 data-1-15 data-1-18 data-2-24)
           (SCRIPT-IO script19 data-1-10 data-1-13 data-2-28)
           (SCRIPT-IO script20 data-1-26 data-1-10 data-2-22)
           (SCRIPT-IO script21 data-1-19 data-1-26 data-2-3)
           (SCRIPT-IO script22 data-1-17 data-0-7 data-2-9)
           (SCRIPT-IO script23 data-1-15 data-0-1 data-2-14)
           (SCRIPT-IO script24 data-1-17 data-0-1 data-2-14)
           (SCRIPT-IO script25 data-1-15 data-1-17 data-2-22)
           (SCRIPT-IO script26 data-1-18 data-0-27 data-2-14)
           (SCRIPT-IO script27 data-0-1 data-0-8 data-1-18)
           (SCRIPT-IO script28 data-0-20 data-0-27 data-1-18)
           (SCRIPT-IO script29 data-0-6 data-0-23 data-1-12)
           (SCRIPT-IO script30 data-0-27 data-0-23 data-1-13)
           (SCRIPT-IO script31 data-0-23 data-0-6 data-1-17)
           ...
           (= (process-cost script6 server4) 4)
           ...
           (= (process-cost script8 server1) 28)
           ...
           (= (process-cost script13 server1) 27)
           ...
           (= (process-cost script25 server3) 4)
           ...
           (= (process-cost script29 server4) 5)
