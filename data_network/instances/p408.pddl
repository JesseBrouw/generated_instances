(define (problem p42-5-65-prob-42-5-65-tiny-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           (SCRIPT-IO script1 data-0-1 data-0-38 data-1-2)
           (SCRIPT-IO script2 data-0-30 data-0-17 data-1-8)
           (SCRIPT-IO script3 data-0-23 data-0-30 data-1-15)
           (SCRIPT-IO script4 data-0-7 data-0-23 data-1-19)
           (SCRIPT-IO script5 data-0-31 data-0-38 data-1-22)
           (SCRIPT-IO script6 data-0-17 data-0-31 data-1-24)
           (SCRIPT-IO script7 data-0-31 data-0-17 data-1-28)
           (SCRIPT-IO script8 data-0-39 data-0-1 data-1-34)
           (SCRIPT-IO script9 data-0-7 data-0-1 data-1-40)
           (SCRIPT-IO script10 data-0-31 data-0-6 data-1-41)
           (SCRIPT-IO script11 data-1-34 data-1-40 data-2-3)
           (SCRIPT-IO script12 data-1-22 data-0-6 data-2-11)
           (SCRIPT-IO script13 data-1-41 data-0-7 data-2-16)
           (SCRIPT-IO script14 data-1-19 data-1-15 data-2-20)
           (SCRIPT-IO script15 data-1-34 data-0-30 data-2-21)
           (SCRIPT-IO script16 data-1-2 data-1-15 data-2-32)
           (SCRIPT-IO script17 data-1-28 data-0-7 data-2-33)
           (SCRIPT-IO script18 data-1-34 data-1-2 data-2-37)
           (SCRIPT-IO script19 data-2-33 data-1-8 data-3-4)
           (SCRIPT-IO script20 data-2-16 data-0-30 data-3-9)
           (SCRIPT-IO script21 data-2-3 data-2-32 data-3-14)
           (SCRIPT-IO script22 data-2-32 data-1-15 data-3-25)
           (SCRIPT-IO script23 data-2-11 data-1-22 data-3-27)
           (SCRIPT-IO script24 data-2-16 data-0-31 data-3-29)
           (SCRIPT-IO script25 data-2-32 data-0-39 data-3-35)
           (SCRIPT-IO script26 data-2-32 data-0-39 data-3-42)
           (SCRIPT-IO script27 data-3-25 data-1-8 data-4-5)
           (SCRIPT-IO script28 data-3-35 data-1-22 data-4-10)
           (SCRIPT-IO script29 data-3-27 data-3-35 data-4-12)
           (SCRIPT-IO script30 data-3-29 data-0-38 data-4-18)
           (SCRIPT-IO script31 data-3-25 data-1-15 data-4-26)
           (SCRIPT-IO script32 data-3-42 data-1-24 data-4-36)
           (SCRIPT-IO script33 data-0-38 data-0-23 data-1-24)
           (SCRIPT-IO script34 data-0-6 data-0-38 data-1-8)
           (SCRIPT-IO script35 data-2-37 data-0-13 data-3-29)
           (SCRIPT-IO script36 data-0-1 data-0-13 data-1-15)
           (SCRIPT-IO script37 data-1-8 data-0-17 data-2-32)
           (SCRIPT-IO script38 data-3-35 data-0-31 data-4-5)
           (SCRIPT-IO script39 data-2-21 data-2-16 data-3-42)
           (SCRIPT-IO script40 data-0-1 data-0-38 data-1-19)
           (SCRIPT-IO script41 data-0-39 data-0-1 data-1-15)
           (SCRIPT-IO script42 data-0-38 data-0-6 data-1-19)
           (SCRIPT-IO script43 data-2-21 data-2-20 data-3-27)
           (SCRIPT-IO script44 data-2-20 data-2-37 data-3-25)
           (SCRIPT-IO script45 data-3-42 data-2-21 data-4-36)
           (SCRIPT-IO script46 data-3-27 data-0-1 data-4-12)
           (SCRIPT-IO script47 data-3-4 data-3-29 data-4-18)
           (SCRIPT-IO script48 data-2-37 data-1-8 data-3-35)
           (SCRIPT-IO script49 data-3-14 data-2-16 data-4-5)
           (SCRIPT-IO script50 data-0-6 data-0-17 data-1-15)
           (SCRIPT-IO script51 data-0-6 data-0-31 data-1-22)
           (SCRIPT-IO script52 data-3-27 data-2-33 data-4-10)
           (SCRIPT-IO script53 data-1-28 data-0-1 data-2-16)
           (SCRIPT-IO script54 data-2-21 data-1-28 data-3-35)
           (SCRIPT-IO script55 data-0-31 data-0-1 data-1-28)
           (SCRIPT-IO script56 data-3-4 data-0-13 data-4-10)
           (SCRIPT-IO script57 data-3-25 data-0-31 data-4-12)
           (SCRIPT-IO script58 data-2-32 data-2-21 data-3-42)
           (SCRIPT-IO script59 data-3-4 data-0-30 data-4-5)
           (SCRIPT-IO script60 data-3-35 data-1-41 data-4-26)
           (SCRIPT-IO script61 data-1-41 data-0-23 data-2-21)
           (SCRIPT-IO script62 data-2-32 data-0-23 data-3-35)
           (SCRIPT-IO script63 data-2-33 data-0-38 data-3-25)
           (SCRIPT-IO script64 data-3-27 data-3-42 data-4-12)
           (SCRIPT-IO script65 data-3-25 data-0-7 data-4-36)
           ...
           (DATA-SIZE data-1-34 number4)
           (DATA-SIZE data-1-40 number2)
           (DATA-SIZE data-1-41 number4)
           ...
           (DATA-SIZE data-3-14 number3)
           (DATA-SIZE data-3-25 number2)
           (DATA-SIZE data-3-27 number2)
           (DATA-SIZE data-3-29 number1)
           (DATA-SIZE data-3-35 number3)
           (DATA-SIZE data-3-42 number5)
           (DATA-SIZE data-4-5 number4)
           (DATA-SIZE data-4-10 number5)
           (DATA-SIZE data-4-12 number3)
           (DATA-SIZE data-4-18 number3)
           (DATA-SIZE data-4-26 number2)
           (DATA-SIZE data-4-36 number2)
           ...
           (= (process-cost script11 server2) 4)
           ...
           (= (process-cost script45 server2) 13)
           ...
           (= (process-cost script51 server2) 5)
           (= (process-cost script51 server3) 11)
           (= (process-cost script52 server1) 26)
           ...
           (= (process-cost script56 server2) 11)
           ...
           (= (process-cost script61 server3) 12)
           ...
           (= (process-cost script64 server3) 13)
           (= (process-cost script65 server1) 20)
           (= (process-cost script65 server2) 4)
    ...
    (:goal
           (and
                ...
                (saved data-4-10 server1)
                (saved data-4-12 server2)
                (saved data-4-18 server3)
                (saved data-4-26 server1)
                (saved data-4-36 server1)
           )
    )
