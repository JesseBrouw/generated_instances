(define (problem p12-2-20-prob-12-2-20-ring-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           (SCRIPT-IO script1 data-0-4 data-0-3 data-1-2)
           (SCRIPT-IO script2 data-0-4 data-0-9 data-1-5)
           (SCRIPT-IO script3 data-0-8 data-0-10 data-1-6)
           (SCRIPT-IO script4 data-0-1 data-0-9 data-1-7)
           (SCRIPT-IO script5 data-0-8 data-0-3 data-1-11)
           (SCRIPT-IO script6 data-0-4 data-0-1 data-1-12)
           (SCRIPT-IO script7 data-0-9 data-0-4 data-1-11)
           (SCRIPT-IO script8 data-0-4 data-0-3 data-1-11)
           (SCRIPT-IO script9 data-0-4 data-0-10 data-1-2)
           (SCRIPT-IO script10 data-0-3 data-0-10 data-1-6)
           (SCRIPT-IO script11 data-0-3 data-0-1 data-1-2)
           (SCRIPT-IO script12 data-0-10 data-0-3 data-1-6)
           (SCRIPT-IO script13 data-0-3 data-0-9 data-1-5)
           (SCRIPT-IO script14 data-0-8 data-0-1 data-1-6)
           (SCRIPT-IO script15 data-0-1 data-0-4 data-1-7)
           (SCRIPT-IO script16 data-0-1 data-0-9 data-1-6)
           (SCRIPT-IO script17 data-0-1 data-0-4 data-1-6)
           (SCRIPT-IO script18 data-0-3 data-0-10 data-1-11)
           (SCRIPT-IO script19 data-0-1 data-0-4 data-1-7)
           (SCRIPT-IO script20 data-0-9 data-0-1 data-1-5)
