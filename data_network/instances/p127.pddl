(define (problem p37-5-39-prob-37-5-39-ring-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (= (process-cost script6 server5) 29)
           ...
           (= (process-cost script8 server7) 28)
           ...
           (= (process-cost script10 server5) 29)
           ...
           (= (process-cost script12 server5) 28)
           ...
           (= (process-cost script18 server3) 29)
           ...
           (= (process-cost script21 server6) 14)
           ...
           (= (process-cost script27 server5) 25)
           ...
           (= (process-cost script35 server3) 30)
           ...
           (= (process-cost script37 server2) 25)
    ...
    (:goal
           (and
                ...
                (saved data-2-33 server5)
                (saved data-4-5 server7)
                (saved data-4-16 server4)
                (saved data-4-25 server7)
                (saved data-4-29 server7)
                (saved data-4-35 server5)
           )
    )
