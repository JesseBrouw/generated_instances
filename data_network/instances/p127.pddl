(define (problem p22-5-35-prob-22-5-35-small-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           (SCRIPT-IO script1 data-0-6 data-0-18 data-1-2)
           (SCRIPT-IO script2 data-0-8 data-0-6 data-1-17)
           (SCRIPT-IO script3 data-0-1 data-0-18 data-1-19)
           (SCRIPT-IO script4 data-1-19 data-0-18 data-2-3)
           (SCRIPT-IO script5 data-2-3 data-0-18 data-3-4)
           (SCRIPT-IO script6 data-2-3 data-1-2 data-3-15)
           (SCRIPT-IO script7 data-2-3 data-1-17 data-3-16)
           (SCRIPT-IO script8 data-3-16 data-0-9 data-4-5)
           (SCRIPT-IO script9 data-3-16 data-1-19 data-4-11)
           (SCRIPT-IO script10 data-3-16 data-0-8 data-4-12)
           (SCRIPT-IO script11 data-3-4 data-1-19 data-4-13)
           (SCRIPT-IO script12 data-3-16 data-3-15 data-4-14)
           (SCRIPT-IO script13 data-3-15 data-0-6 data-4-20)
           (SCRIPT-IO script14 data-0-1 data-0-7 data-1-17)
           (SCRIPT-IO script15 data-2-3 data-0-6 data-3-16)
           (SCRIPT-IO script16 data-3-15 data-1-2 data-4-12)
           (SCRIPT-IO script17 data-3-4 data-1-2 data-4-11)
           (SCRIPT-IO script18 data-1-19 data-1-17 data-2-3)
           (SCRIPT-IO script19 data-3-15 data-0-7 data-4-12)
           (SCRIPT-IO script20 data-3-16 data-1-19 data-4-20)
           (SCRIPT-IO script21 data-1-2 data-0-7 data-2-3)
           (SCRIPT-IO script22 data-3-15 data-0-6 data-4-12)
           (SCRIPT-IO script23 data-1-19 data-0-9 data-2-3)
           (SCRIPT-IO script24 data-2-3 data-0-1 data-3-4)
           (SCRIPT-IO script25 data-2-3 data-1-17 data-3-15)
           (SCRIPT-IO script26 data-0-8 data-0-9 data-1-17)
           (SCRIPT-IO script27 data-1-19 data-0-8 data-2-3)
           (SCRIPT-IO script28 data-1-2 data-0-21 data-2-3)
           (SCRIPT-IO script29 data-3-15 data-2-3 data-4-12)
           (SCRIPT-IO script30 data-3-16 data-3-4 data-4-5)
           (SCRIPT-IO script31 data-3-4 data-1-2 data-4-20)
           (SCRIPT-IO script32 data-0-10 data-0-1 data-1-2)
           (SCRIPT-IO script33 data-3-15 data-2-3 data-4-20)
           (SCRIPT-IO script34 data-1-17 data-1-19 data-2-3)
           (SCRIPT-IO script35 data-1-2 data-0-7 data-2-3)
           ...
           (DATA-SIZE data-4-13 number2)
           (DATA-SIZE data-4-14 number1)
           (DATA-SIZE data-4-20 number1)
           ...
           (= (process-cost script16 server1) 31)
           ...
           (= (process-cost script18 server2) 3)
