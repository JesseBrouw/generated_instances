(define (problem p22-5-35-prob-22-5-35-ring-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (= (process-cost script3 server6) 29)
           ...
           (= (process-cost script18 server4) 29)
           ...
           (= (process-cost script25 server5) 10)
    ...
    (:goal
           (and
                ...
                (saved data-4-14 server5)
                (saved data-4-15 server5)
