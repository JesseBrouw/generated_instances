(define (problem p16-2-26-prob-16-2-26-ring-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           (SCRIPT-IO script1 data-0-15 data-0-16 data-1-2)
           (SCRIPT-IO script2 data-0-8 data-0-3 data-1-4)
           (SCRIPT-IO script3 data-0-16 data-0-7 data-1-5)
           (SCRIPT-IO script4 data-0-1 data-0-10 data-1-6)
           (SCRIPT-IO script5 data-0-15 data-0-10 data-1-9)
           (SCRIPT-IO script6 data-0-7 data-0-10 data-1-12)
           (SCRIPT-IO script7 data-0-7 data-0-16 data-1-13)
           (SCRIPT-IO script8 data-0-16 data-0-3 data-1-14)
           (SCRIPT-IO script9 data-0-16 data-0-15 data-1-14)
           (SCRIPT-IO script10 data-0-7 data-0-11 data-1-2)
           (SCRIPT-IO script11 data-0-16 data-0-3 data-1-5)
           (SCRIPT-IO script12 data-0-1 data-0-16 data-1-12)
           (SCRIPT-IO script13 data-0-15 data-0-1 data-1-4)
           (SCRIPT-IO script14 data-0-11 data-0-3 data-1-5)
           (SCRIPT-IO script15 data-0-3 data-0-15 data-1-4)
           (SCRIPT-IO script16 data-0-7 data-0-15 data-1-9)
           (SCRIPT-IO script17 data-0-1 data-0-8 data-1-6)
           (SCRIPT-IO script18 data-0-7 data-0-1 data-1-2)
           (SCRIPT-IO script19 data-0-15 data-0-7 data-1-9)
           (SCRIPT-IO script20 data-0-7 data-0-10 data-1-2)
           (SCRIPT-IO script21 data-0-15 data-0-11 data-1-4)
           (SCRIPT-IO script22 data-0-15 data-0-8 data-1-13)
           (SCRIPT-IO script23 data-0-7 data-0-3 data-1-2)
           (SCRIPT-IO script24 data-0-1 data-0-3 data-1-9)
           (SCRIPT-IO script25 data-0-15 data-0-3 data-1-12)
           (SCRIPT-IO script26 data-0-11 data-0-3 data-1-12)
           ...
           (= (process-cost script7 server7) 27)
           (= (process-cost script8 server1) 4)
           ...
           (= (process-cost script17 server2) 29)
           ...
           (= (process-cost script17 server7) 29)
           ...
           (= (process-cost script23 server2) 31)
    ...
    (:goal
           (and
                ...
                (saved data-1-12 server7)
                (saved data-1-13 server6)
                (saved data-1-14 server2)
           )
    )
