(define (problem p18-2-29-prob-18-2-29-ring-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (SCRIPT-IO script3 data-0-3 data-0-16 data-1-9)
           (SCRIPT-IO script4 data-0-16 data-0-6 data-1-10)
           (SCRIPT-IO script5 data-0-16 data-0-15 data-1-11)
           (SCRIPT-IO script6 data-0-6 data-0-14 data-1-12)
           (SCRIPT-IO script7 data-0-8 data-0-3 data-1-13)
           (SCRIPT-IO script8 data-0-6 data-0-7 data-1-17)
           (SCRIPT-IO script9 data-0-16 data-0-3 data-1-18)
           (SCRIPT-IO script10 data-0-1 data-0-6 data-1-11)
           (SCRIPT-IO script11 data-0-1 data-0-7 data-1-9)
           (SCRIPT-IO script12 data-0-15 data-0-16 data-1-9)
           (SCRIPT-IO script13 data-0-6 data-0-15 data-1-13)
           (SCRIPT-IO script14 data-0-7 data-0-8 data-1-17)
           (SCRIPT-IO script15 data-0-14 data-0-16 data-1-10)
           (SCRIPT-IO script16 data-0-4 data-0-15 data-1-2)
           (SCRIPT-IO script17 data-0-15 data-0-6 data-1-17)
           (SCRIPT-IO script18 data-0-16 data-0-15 data-1-2)
           (SCRIPT-IO script19 data-0-3 data-0-6 data-1-17)
           (SCRIPT-IO script20 data-0-16 data-0-14 data-1-2)
           (SCRIPT-IO script21 data-0-8 data-0-14 data-1-11)
           (SCRIPT-IO script22 data-0-8 data-0-15 data-1-9)
           (SCRIPT-IO script23 data-0-7 data-0-15 data-1-18)
           (SCRIPT-IO script24 data-0-7 data-0-1 data-1-17)
           (SCRIPT-IO script25 data-0-1 data-0-15 data-1-9)
           (SCRIPT-IO script26 data-0-15 data-0-16 data-1-5)
           (SCRIPT-IO script27 data-0-1 data-0-3 data-1-11)
           (SCRIPT-IO script28 data-0-4 data-0-6 data-1-18)
           (SCRIPT-IO script29 data-0-4 data-0-15 data-1-5)
           ...
           (= (process-cost script3 server7) 28)
           ...
           (= (process-cost script8 server5) 25)
    ...
    (:goal
           (and
                ...
                (saved data-1-11 server4)
                (saved data-1-12 server4)
                (saved data-1-13 server4)
                (saved data-1-17 server7)
