(define (problem p20-3-32-prob-20-3-32-ring-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           ...
           (= (process-cost script12 server3) 27)
           ...
           (= (process-cost script25 server7) 29)
           ...
           (= (process-cost script32 server7) 8)
