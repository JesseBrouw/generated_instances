(define (problem p18-2-29-prob-18-2-29-small-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-3
    ...
    (:init
           ...
           (= (process-cost script27 server1) 29)
    ...
    (:goal
           (and
                ...
                (saved data-1-4 server4)
                (saved data-1-7 server3)
                (saved data-1-10 server3)
                (saved data-1-11 server2)
                (saved data-1-12 server3)
