(define (problem p29-3-31-prob-29-3-31-ring-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           ...
           (= (process-cost script13 server5) 30)
           ...
           (= (process-cost script29 server5) 11)
           ...
           (= (process-cost script31 server6) 29)
