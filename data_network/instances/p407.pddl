(define (problem p42-5-44-prob-42-5-44-tiny-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (= (process-cost script2 server3) 3)
           ...
           (= (process-cost script16 server1) 27)
           ...
           (= (process-cost script21 server3) 5)
           ...
           (= (process-cost script31 server2) 14)
    ...
    (:goal
           (and
                ...
                (saved data-2-40 server3)
                (saved data-2-42 server2)
                (saved data-3-38 server3)
                (saved data-4-5 server3)
                (saved data-4-11 server2)
                (saved data-4-20 server3)
                (saved data-4-24 server3)
                (saved data-4-30 server2)
                (saved data-4-36 server1)
                (saved data-4-39 server2)
           )
    )
