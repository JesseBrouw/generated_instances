(define (problem p30-4-32-prob-30-4-32-ring-network-2-2)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           ...
           (= (process-cost script7 server5) 29)
           (= (process-cost script7 server6) 17)
           (= (process-cost script7 server7) 28)
           ...
           (= (process-cost script22 server5) 7)
