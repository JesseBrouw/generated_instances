(define (problem p26-4-41-prob-26-4-41-tiny-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-5
    ...
    (:init
           (SCRIPT-IO script1 data-0-16 data-0-5 data-1-2)
           (SCRIPT-IO script2 data-0-5 data-0-13 data-1-8)
           (SCRIPT-IO script3 data-0-15 data-0-1 data-1-10)
           (SCRIPT-IO script4 data-0-5 data-0-13 data-1-11)
           (SCRIPT-IO script5 data-0-15 data-0-12 data-1-14)
           (SCRIPT-IO script6 data-0-15 data-0-1 data-1-17)
           (SCRIPT-IO script7 data-0-16 data-0-13 data-1-21)
           (SCRIPT-IO script8 data-1-8 data-0-1 data-2-3)
           (SCRIPT-IO script9 data-1-14 data-1-10 data-2-9)
           (SCRIPT-IO script10 data-1-10 data-1-2 data-2-20)
           (SCRIPT-IO script11 data-1-21 data-1-11 data-2-23)
           (SCRIPT-IO script12 data-1-21 data-1-17 data-2-26)
           (SCRIPT-IO script13 data-2-26 data-1-8 data-3-4)
           (SCRIPT-IO script14 data-2-23 data-2-3 data-3-6)
           (SCRIPT-IO script15 data-2-3 data-2-20 data-3-7)
           (SCRIPT-IO script16 data-2-9 data-0-12 data-3-18)
           (SCRIPT-IO script17 data-2-3 data-0-5 data-3-19)
           (SCRIPT-IO script18 data-2-9 data-1-11 data-3-24)
           (SCRIPT-IO script19 data-2-3 data-0-16 data-3-25)
           (SCRIPT-IO script20 data-1-17 data-0-12 data-2-26)
           (SCRIPT-IO script21 data-0-16 data-0-13 data-1-11)
           (SCRIPT-IO script22 data-1-11 data-0-13 data-2-3)
           (SCRIPT-IO script23 data-0-15 data-0-16 data-1-21)
           (SCRIPT-IO script24 data-0-1 data-0-15 data-1-8)
           (SCRIPT-IO script25 data-2-20 data-0-5 data-3-4)
           (SCRIPT-IO script26 data-1-10 data-0-15 data-2-3)
           (SCRIPT-IO script27 data-0-5 data-0-22 data-1-14)
           (SCRIPT-IO script28 data-0-1 data-0-12 data-1-8)
           (SCRIPT-IO script29 data-1-14 data-0-12 data-2-20)
           (SCRIPT-IO script30 data-2-3 data-1-10 data-3-25)
           (SCRIPT-IO script31 data-2-20 data-0-22 data-3-25)
           (SCRIPT-IO script32 data-1-10 data-0-22 data-2-9)
           (SCRIPT-IO script33 data-0-16 data-0-5 data-1-21)
           (SCRIPT-IO script34 data-2-26 data-2-3 data-3-6)
           (SCRIPT-IO script35 data-1-8 data-1-2 data-2-3)
           (SCRIPT-IO script36 data-1-8 data-1-21 data-2-23)
           (SCRIPT-IO script37 data-1-14 data-1-21 data-2-26)
           (SCRIPT-IO script38 data-1-11 data-1-2 data-2-3)
           (SCRIPT-IO script39 data-1-17 data-1-14 data-2-20)
           (SCRIPT-IO script40 data-1-17 data-0-16 data-2-3)
           (SCRIPT-IO script41 data-1-17 data-0-22 data-2-9)
           ...
           (= (process-cost script25 server1) 29)
           ...
           (= (process-cost script31 server3) 5)
    ...
    (:goal
           (and
                ...
                (saved data-3-24 server3)
                (saved data-3-25 server1)
           )
    )
