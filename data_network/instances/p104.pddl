(define (problem p7-5-12-prob-7-5-12-ring-network-1-1)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-6
    ...
    (:init
           ...
           (SCRIPT-IO script5 data-3-4 data-0-6 data-4-5)
           (SCRIPT-IO script6 data-0-1 data-0-6 data-1-2)
           (SCRIPT-IO script7 data-2-3 data-0-6 data-3-4)
           (SCRIPT-IO script8 data-3-4 data-1-7 data-4-5)
           (SCRIPT-IO script9 data-3-4 data-2-3 data-4-5)
           (SCRIPT-IO script10 data-0-6 data-0-1 data-1-2)
           (SCRIPT-IO script11 data-1-7 data-0-1 data-2-3)
           (SCRIPT-IO script12 data-1-2 data-0-6 data-2-3)
