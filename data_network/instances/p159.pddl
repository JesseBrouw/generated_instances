(define (problem p14-3-16-prob-14-3-16-tiny-network-None-None)
    (:domain data-network)
    (:objects
              data-0-1
              data-0-4
    ...
    (:init
           ...
           (SCRIPT-IO script2 data-0-10 data-0-13 data-1-5)
           (SCRIPT-IO script3 data-0-13 data-0-14 data-1-7)
           (SCRIPT-IO script4 data-0-6 data-0-1 data-1-9)
           (SCRIPT-IO script5 data-0-13 data-0-14 data-1-11)
           (SCRIPT-IO script6 data-1-11 data-1-9 data-2-3)
           (SCRIPT-IO script7 data-1-5 data-1-2 data-2-8)
           (SCRIPT-IO script8 data-1-2 data-1-9 data-2-12)
           (SCRIPT-IO script9 data-0-14 data-0-13 data-1-7)
           (SCRIPT-IO script10 data-1-11 data-0-6 data-2-8)
           (SCRIPT-IO script11 data-1-11 data-0-10 data-2-3)
           (SCRIPT-IO script12 data-0-6 data-0-1 data-1-7)
           (SCRIPT-IO script13 data-1-2 data-0-1 data-2-12)
           (SCRIPT-IO script14 data-1-9 data-0-4 data-2-3)
           (SCRIPT-IO script15 data-1-5 data-0-1 data-2-12)
           (SCRIPT-IO script16 data-0-13 data-0-1 data-1-11)
           ...
           (= (process-cost script9 server1) 28)
