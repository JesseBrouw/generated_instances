...
:parameters (?avail ?new-avail - count)
:precondition (and (started o11)(made p4)(made p10)(made p20)(made p26)(made p30)(made p49)(stacks-avail ?avail)(next-count ?avail ?new-avail))
...
:parameters (?avail ?new-avail - count)
:precondition (and (started o43)(made p1)(made p33)(made p34)(made p39)(made p40)(made p48)(made p52)(stacks-avail ?avail)(next-count ?avail ?new-avail))
:effect (and (not (started o43))(shipped o43)(not (stacks-avail ?avail))(stacks-avail ?new-avail)))

(:action ship-order-o44
:parameters (?avail ?new-avail - count)
:precondition (and (started o44)(made p38)(made p43)(made p52)(made p53)(stacks-avail ?avail)(next-count ?avail ?new-avail))
:effect (and (not (started o44))(shipped o44)(not (stacks-avail ?avail))(stacks-avail ?new-avail)))

(:action ship-order-o45
:parameters (?avail ?new-avail - count)
:precondition (and (started o45)(made p38)(made p40)(made p41)(made p52)(stacks-avail ?avail)(next-count ?avail ?new-avail))
:effect (and (not (started o45))(shipped o45)(not (stacks-avail ?avail))(stacks-avail ?new-avail)))

(:action ship-order-o46
:parameters (?avail ?new-avail - count)
:precondition (and (started o46)(made p32)(made p35)(made p48)(made p51)(made p53)(stacks-avail ?avail)(next-count ?avail ?new-avail))
