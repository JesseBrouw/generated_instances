; Transport city-sequential-5nodes-1000size-5degree-100mindistance-2trucks-13packages-2seed

(define (problem transport-city-sequential-5nodes-1000size-5degree-100mindistance-2trucks-13packages-2seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
