; Transport two-cities-sequential-5nodes-1000size-4degree-100mindistance-3trucks-6packages-1seed

(define (problem transport-two-cities-sequential-5nodes-1000size-4degree-100mindistance-3trucks-6packages-1seed)
 (:domain transport)
 (:objects
