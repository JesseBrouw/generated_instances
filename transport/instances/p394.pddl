; Transport city-sequential-5nodes-1000size-3degree-100mindistance-2trucks-11packages-1seed

(define (problem transport-city-sequential-5nodes-1000size-3degree-100mindistance-2trucks-11packages-1seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
