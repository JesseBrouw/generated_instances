; Transport two-cities-sequential-5nodes-1000size-4degree-100mindistance-3trucks-3packages-2seed

(define (problem transport-two-cities-sequential-5nodes-1000size-4degree-100mindistance-3trucks-3packages-2seed)
 (:domain transport)
 (:objects
