; Transport three-cities-sequential-11nodes-1000size-3degree-100mindistance-2trucks-8packages-1seed

(define (problem transport-three-cities-sequential-11nodes-1000size-3degree-100mindistance-2trucks-8packages-1seed)
 (:domain transport)
 (:objects
